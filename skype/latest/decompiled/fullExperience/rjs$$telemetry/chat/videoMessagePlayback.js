define("telemetry/chat/videoMessagePlayback", [
  ...
  function i() {
    ...
    e.sendLoadedEvent = function () {
      s.action = n.chat.VIDEO_MESSAGE.eventName.LOADED, o(s);
    }, e.sendFirstPlayAction = function () {
      s.action = n.chat.VIDEO_MESSAGE.action.FIRST_PLAY, o(s);
    }, e.sendFullscreenAction = function () {
      s.action = n.chat.VIDEO_MESSAGE.action.FULLSCREEN, o(s);
    }, e.sendSeekAction = function () {
      s.action = n.chat.VIDEO_MESSAGE.action.SEEK, o(s);
    }, e.sendReplayAction = function () {
      s.action = n.chat.VIDEO_MESSAGE.action.REPLAY, o(s);
    };
  }
