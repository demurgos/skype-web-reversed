define("telemetry/chat/conversationUpdateFlow", [
  ...
  function h() {
    ...
    function d() {
      e.ttc = p(r.CONVERSATION_UPDATE.TTC, n.CONVERSATION_UPDATE.UPDATE_START, n.CONVERSATION_UPDATE.UPDATE_END);
      e.isCompleted && (e.tts = p(r.CONVERSATION_UPDATE.TTS, n.CONVERSATION_UPDATE.UPDATE_END, n.CONVERSATION_UPDATE.SYNC_END));
    }
    function v() {
    ...
    function m(t, r) {
      e.stage = t;
      f.mark(n.CONVERSATION_UPDATE.UPDATE_END);
      r && v();
    }
    var e = this;
    e.start = function (t, r) {
      ...
      e.contactsCount = s.contactsInfo().totalContacts;
      e.conversationType = r ? a.GROUP : a.DIALOG;
      f.mark(n.CONVERSATION_UPDATE.UPDATE_START);
    };
