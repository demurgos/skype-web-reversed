define("utils/common/appVisibilityProvider", [
  ...
  t.hasFocus = n.observable(), t.isVisible = function (e) {
    e && s.tryRestoreFocus();
  }, t.init = function () {
    i.addEventListener("focus", t.hasFocus.bind(null, !0)), i.addEventListener("blur", t.hasFocus.bind(null, !1)), t.hasFocus(r.hasFocus());
  };
})
