define("jSkype/utils/chat/cacheBase", [
  ...
  function u(e, u) {
    ...
    a.size = c.size, a.log = function () {
      ...
      a.log("resetting:", e), e && a._emptyCache(), h = {};
    }, a._emptyCache = a.clean, a._obtain = function () {
      ...
      return t.isEmpty(h) ? [] : (e = c().sort(u), n = [], r = !1, e.forEach(function (e) {
        !r && h[e.id] && (r = !0), r && !h[e.id] && n.push(e);
      }), v(n), n);
    };
  }
