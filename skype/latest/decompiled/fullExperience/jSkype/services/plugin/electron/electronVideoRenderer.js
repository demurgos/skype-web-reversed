define("jSkype/services/plugin/electron/electronVideoRenderer", [
  ...
  function o(e) {
    n.call(this), this._parentElementId = e, this._renderer = new this._skypeModule.VideoRenderer(), this._renderer.onVideoResolutionChanged = o.prototype._raiseVideoResolutionChanged.bind(this);
  }
  ...
  o.prototype = Object.create(n.prototype), o.prototype.constructor = o, o.prototype.load = function () {
    var e = s.getElementById(this._parentElementId);
    try {
      this._renderer.initialize(e), this._raiseLoadComplete(!0);
    } catch (t) {
      i.warn(t), this._raiseLoadComplete(!1);
    }
    ...
    delete this._parentElementId, delete this._renderer, n.prototype.dispose.call(this, e);
    ...
    this._renderer.setScalingMode(r[e]), t && t();
  }, o.prototype._raiseVideoResolutionChanged = function (e, t) {
    this._raiseEvent("VideoResolutionChanged", {
      width: e,
      height: t
    });
  }, o.prototype.setupVideo = r.prototype.setupVideo, t.build = function (e) {
    return new o(e);
  };
})
