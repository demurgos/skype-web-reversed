define("jSkype/services/asyncMedia/main", [
  ...
  function b(e, t, n, r, s, o, u) {
    ...
    f.upload.addEventListener("progress", c), f.open("PUT", a + "/content/" + l.content, !0), f.setRequestHeader("Authorization", "skype_token " + n), f.setRequestHeader("Content-Type", "multipart/form-data"), f.send(t), f.onreadystatechange = function () {
      f.readyState === 4 && (f.status === 201 ? E(t, a, function () {
        u(a + "/views/" + l.thumbnail), r(e);
      }, function () {
