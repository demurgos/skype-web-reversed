define("notifications/common/notification", [
  ...
  return function (e, r, o, u) {
    ...
    this.type = e, this.sender = r || {}, o = o || {}, this.title = t.observable(""), this.description = t.observable(""), this.active = t.observable(!1), this.accept = function () {
      p.action = i.action.accept, a.active() && o.accept && (o.accept.apply(null, arguments), h.send(p)), a.active(!1);
    }, this.decline = function () {
      p.action = i.action.decline, a.active() && o.decline && (o.decline(), h.send(p)), a.active(!1);
    }, this.open = function () {
      p.action = i.action.open, a.active() && o.open && (o.open(), h.send(p)), a.active(!1);
    }, this.sound = {
      play: function () {
