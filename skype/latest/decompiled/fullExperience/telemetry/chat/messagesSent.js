define("telemetry/chat/messagesSent", [
  ...
  function i() {
    this.publish = function (i) {
      ...
      a.totalCount = i.length, a.failedCount = 0, a.balance404Count = 0, a.tts = [], a.t404 = [];
      ...
      a.ttsAvg = u / a.totalCount, a.deliveryRate = (1 - a.failedCount / a.totalCount) * 100, t.push(f);
    };
  }
