define("telemetry/chat/conversationHistoryLoad", [
  ...
  function a(e) {
    ...
    a._context = {
      ...
      if (!r)
        return;
      a._context.isUnread = !r.isRead(), a._context.timeInStale = 0;
      if (a._context.isUnread) {
        var i = +new Date();
        a._context.timeInStale = (i - r.timestamp()) / 1000;
      }
    }(), a.start = function () {
      a._context.startTime = new Date().getTime(), a._context.timer = setTimeout(a.publish, a._context.SYNC_TIMEOUT);
    }, a.registerSync = function () {
      a._context.timer || (a._context.pageNumber++, a.start()), a._context.syncEndTime = new Date().getTime(), a._context.renderEndTime = a._context.syncEndTime;
    }, a.registerRender = function () {
      a._context.renderEndTime = new Date().getTime();
    }, a.registerError = function () {
      a._context.hasError = !0, a._context.syncEndTime = new Date().getTime(), a.publish();
    }, a.dispose = function () {
