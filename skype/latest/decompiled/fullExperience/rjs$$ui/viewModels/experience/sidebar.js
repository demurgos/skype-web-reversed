define("ui/viewModels/experience/sidebar", [
  ...
  function g(e) {
    function L(e) {
      e(v.NAVIGATE, P);
      e(v.OPEN_CONVERSATION, P);
      e(d.SHOW_SIDEBAR, g.slideIn);
      e(d.HIDE_SIDEBAR, g.slideOut);
    }
    function A(e) {
      e(m.QUERY_CHANGED, D);
      e(m.INPUT_FOCUS, O);
    ...
    function H() {
      !g.isExpanded() && (T || x) && g.expand();
      k.resize();
    }
    function B(e) {
      clearTimeout(C);
      e.timeout ? C = i.setTimeout(g.isExpanded.bind(g, e.expanded), e.timeout) : g.isExpanded(e.expanded);
    }
    function j(e) {
      clearTimeout(N);
      N = i.setTimeout(g.showTooltips.bind(g, e), p);
    }
    function F(e) {
      b.publish(d.SIDEBAR_STATE_CHANGED, e);
    }
    function I(e) {
      L(e ? b.subscribe.bind(b) : b.unsubscribe.bind(b));
      !e && g.isExpanded() && g.isExpanded(!1);
    }
    function q(e) {
      return function () {
    ...
    g.isExpanded = r.observable(!1);
    g.showTooltips = r.observable(!1);
    g.showPreSlideClass = r.observable(!1);
    g.addSlideInClass = r.observable(!1);
    g.addSlideOutClass = r.observable(!1);
    g.init = function () {
      E = g.isActive.subscribe(I);
      S = g.isExpanded.subscribe(F);
      A(b.subscribe.bind(b));
      w = t.debounce(H, l);
      i.addEventListener(o.events.browser.RESIZE, w);
      k = new f(e);
      s.execute(H);
      g.isActive() && L(b.subscribe.bind(b));
    };
    g.dispose = function () {
      k.dispose();
      E.dispose();
      S.dispose();
      L(b.unsubscribe.bind(b));
      A(b.unsubscribe.bind(b));
      i.removeEventListener(o.events.browser.RESIZE, w);
    };
    ...
    g.slideIn = q(function () {
      g.addSlideInClass(!0);
      g.addSlideOutClass(!1);
    });
    g.slideOut = q(function () {
      g.addSlideInClass(!1);
      g.addSlideOutClass(!0);
    });
