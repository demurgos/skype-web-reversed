define("ui/viewModels/people/directoryList", [
  ...
  function c() {
    ...
    t.call(e, s.searchScope.SkypeDirectory);
    e.lastQuery = "";
    e.isActive = !1;
    e.init = function () {
      c().subscribe(l.DIRECTORY_SEARCH_ACTIVATED, e.activate);
      c().subscribe(l.DIRECTORY_SEARCH_DEACTIVATED, e.deactivate);
      o.init.call(e);
    };
    e.dispose = function () {
      c().unsubscribe(l.DIRECTORY_SEARCH_ACTIVATED, e.activate);
      c().unsubscribe(l.DIRECTORY_SEARCH_DEACTIVATED, e.deactivate);
      o.dispose.call(e);
    };
    e.search = function (n) {
      e.lastQuery = n;
    ...
    e.showContextMenu = function (t, n) {
      ...
      r = [new f.UnblockContactMenuItem(t, s)];
      a.show(r, n, i);
    };
    e.activate = function () {
      e.isActive = !0;
