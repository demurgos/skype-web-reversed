define("ui/viewModels/people/contactList", [
  ...
  function c() {
    ...
    l.call(e, i.searchScope.AddressBook);
    e.search = function (r) {
    ...
    e.openConversation = function (o) {
      ...
      r.get().conversationsManager.conversations.add(a);
      u.publish(n.events.search.RESET, l);
      t.sendOpenConversationEvent.call(e, a);
    };
    e.showContextMenu = function (t, r) {
      ...
      p.push(a.getConversationContextMenuItemGroup(t, n.telemetry.historyLoadOrigin.CONTACT_SEARCH, i));
      p.push(new u.BlockContactMenuItem(t, s));
      p.push(new u.UnblockContactMenuItem(t, l));
      p.push(new u.DeleteContactMenuItem(t, n.telemetry.historyLoadOrigin.CONTACT_SEARCH, h));
      a.sortMenuItems(p);
      o.show(p, r, i);
    };
  }
