define("ui/viewModels/chat/pollAvatars", [
  ...
  function o(e, t) {
    function u(e) {
      ...
      o.selectedEllipsis(e), o.users.removeAll(), t.users.forEach(function (e) {
        var t = {};
        t.person = e.person, t.displayName = e.displayName, e.person && (t.contact = i.build(e.person)), o.users.push(t);
      });
    }
    var o = this;
    o.selectedEllipsis = n.observable(-1), o.model = e, o.users = n.observableArray(), o.isSelfPopup = function (e, t) {
      return o.selectedEllipsis() === e && t.key === "polls";
    }, o.onEllipsisClick = function (e, n, r) {
      s.avatarElipsisClicked(o.model), u(e), t({
        key: "polls",
        eventPageY: r.pageY
      });
