define("ui/viewModels/chat/inviteLink", [
  ...
  function g(e, t) {
    ...
    n.init = function () {
      ...
      n.copyActive = r.observable(!1), n.topic = f.newObservableProperty(a), n.uri = f.newObservableProperty(g), n.showCopiedIndicator = r.observable(!1), n.copiedIndicatorText = "", n.tabIndex = e.isMessageContent ? -1 : 0, n.copy = function () {
        n.copyActive(!0), y.select(), S(h.invites.copyButton);
        try {
          var e = document.execCommand("copy");
          n.copyActive(!1), n.copiedIndicatorText = e ? v.fetch({ key: "header_text_copied" }) : v.fetch({ key: "header_text_cant_copy" }), n.showCopiedIndicator(!0), t && s.clearTimeout(t), t = s.setTimeout(i, m), e || x(b);
        } catch (r) {
        }
        n.dispatchEvent(u.conversation.COPY_LINK, { parent: E() }, n.DIRECTION.PARENT);
      }, n.send = function () {
        n.dispatchEvent(u.conversation.EMAIL_LINK, { parent: E() }, n.DIRECTION.PARENT), S(h.invites.mailButton), l.setHref(n.mailtoLink());
      }, n.cancel = function () {
        n.copyActive(!1);
  ...
  n.assign(g.prototype, a), t.classFunction = g, t.build = function (e, t) {
    return new g(e, t);
  };
})
