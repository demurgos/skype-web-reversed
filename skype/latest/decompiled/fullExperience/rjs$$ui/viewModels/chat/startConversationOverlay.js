define("ui/viewModels/chat/startConversationOverlay", [
  ...
  function u(e) {
    ...
    t.avatar = a.avatar;
    t.statusClassName = a.statusClassName;
    t.displayName = a.displayName;
    t.displayMessage = n.computed(l);
    t.locationText = a.locationText;
    t.isAudioDisabled = f.isAudioDisabled;
    t.isVideoDisabled = f.isVideoDisabled;
    t.buttonVideoTitle = f.buttonVideoTitle;
    t.buttonVideoAriaLabel = f.buttonVideoAriaLabel;
    t.buttonCallTitle = f.buttonCallTitle;
    t.buttonCallAriaLabel = f.buttonCallAriaLabel;
    t.forwardEvent(r.events.conversation.OVERLAY_CLOSED);
    t.startCallWithAudio = function () {
      f.startCallWithAudio();
      t.dispatchEvent(r.events.conversation.OVERLAY_CLOSED, t.DIRECTION.PARENT);
    };
    t.startCallWithVideo = function () {
      f.startCallWithVideo();
      t.dispatchEvent(r.events.conversation.OVERLAY_CLOSED, t.DIRECTION.PARENT);
    };
