define("ui/viewModels/chat/translator/translatorSettings", [
  ...
  function d(e) {
    function N() {
      t.dialogOpened(!0);
      p.add(w, C);
      i.body.addEventListener("focus", k, !0);
      i.body.addEventListener("keydown", L, !0);
    }
    function C() {
      t.dialogOpened(!1);
      p.remove(w);
      i.body.removeEventListener("focus", k, !0);
      i.body.removeEventListener("keydown", L, !0);
    }
    function k(e) {
    ...
    function M(e) {
      t.translatorEnabled(!0);
      l._translatorSettings.meLanguage = e;
      T.send(c.eventType.ME_LANGUAGE_CHANGED, {
        language: e.code,
    ...
    function _(e) {
      t.translatorEnabled(!0);
      l._translatorSettings.participantLanguage = e;
      T.send(c.eventType.PARTICIPANT_LANGUAGE_CHANGED, { selectedLanguage: e.code });
    }
    function D() {
      l._translatorSettings.meLanguage = null;
      l._translatorSettings.participantLanguage = null;
    }
    function P() {
      l._translatorSettings.meLanguage = t.meLanguage();
      l._translatorSettings.participantLanguage = t.participantLanguage();
    }
    function H(e) {
    ...
    t.init = function () {
      t.availableLanguages = o.observableArray();
      g = B();
      j();
      t.translatorEnabled = o.observable(!1);
      t.participantAvatar = a.newObservableProperty(l.participants()[0].person.avatarUrl);
      t.participantDisplayName = a.newObservableProperty(l.participants()[0].person.displayName);
      t.participantLanguage = o.observable(O());
      t.meAvatar = a.newObservableProperty(d.avatarUrl);
      t.meDisplayName = a.newObservableProperty(d.displayName);
      t.meLanguage = o.observable(A());
      t.dialogOpened = o.observable(!1);
      t.settingsButtonLabel = s.fetch({ key: "button_translator_translatorSettings" });
      t.settingsButtonAriaLabel = o.computed(function () {
      ...
      t.settingsDialogLabel = s.fetch({ key: "label_translator_translatorSettings" });
      t.meLanguagePickerLabel = o.computed(function () {
        return s.fetch({
      ...
      E = t.translatorEnabled.subscribe(H);
      S = t.participantLanguage.subscribe(_);
      x = t.meLanguage.subscribe(M);
      t.translatorToggleText = o.computed(function () {
        return t.translatorEnabled() ? v : m;
      });
      t.translatorEnabledHandler = function () {
        var e = t.translatorEnabled();
        t.translatorEnabled(!t.translatorEnabled());
        e || T.send(c.eventType.SETTINGS_BUTTON_ENABLED, {
    ...
    t.dispose = function () {
      t.dialogOpened() && C();
      t.participantAvatar.dispose();
      t.participantDisplayName.dispose();
      t.meAvatar.dispose();
      t.meDisplayName.dispose();
      t.translatorToggleText.dispose();
      t.meLanguagePickerLabel.dispose();
      t.theirLanguagePickerLabel.dispose();
      t.settingsButtonAriaLabel.dispose();
      S.dispose();
      x.dispose();
      E.dispose();
    };
