define("ui/viewModels/chat/translator/translationItem", [
  ...
  function c(e, t) {
    ...
    function N(e, n) {
      ...
      x() || c.translationText(e);
      l.isMatchingMyLanguage(r, t._translatorSettings) && (c.translationText(e), c.visible(!0));
      S.send(E, {
    ...
    function A() {
      m && (w = m.observe(k));
      e.model.isDeleted && (b = e.model.isDeleted.changed(function (e) {
        c.isRemoved(e);
        c.visible(!1);
      }));
    }
    ...
    c.init = function () {
      c.isRemoved = s.observable(!1);
      c.visible = s.observable(!1);
      c.translationText = s.observable("");
      c.isEnabled = s.pureComputed(function () {
