define("ui/viewModels/chat/messageSearchItem", [
  ...
  return function () {
    function g(e) {
      ...
      if (s() || o())
        return;
      r = u.get().personsAndGroupsManager.createPersonSearchQuery(), r.sources(h.searchScope.All), r.text("id:" + i), r.getMore().then(function () {
        var e = r.results();
        n = e[0].result, d.avatarUrl(n.avatarUrl()), d.userName(n.displayName());
      });
    }
    function y(e, t) {
      var n = {
    ...
    var d = this, v, m;
    d.init = function (t, r) {
      m = r, v = l.build(m), d.displayMessage = t.Content, d.messageId = t.ClientMessageId, d.isGroupConversation = !1, d.conversation = y(t.CreationDate, m.topic()), d.userName = n.observable(""), d.avatarUrl = n.observable(""), g(t), d.statusClassName = v.statusClassName, d.isAgent = v.isAgent, d.isActive = !1;
    }, d.dispose = function () {
      v.dispose();
    }, d.handleClick = function (t, n) {
      var r = i.telemetry.historyLoadOrigin.TIMELINE_CLICK;
      f.getInstance().startTrace("navigateConversation"), n.preventDefault(), a.publish(p.OPEN_CONVERSATION, {
        model: m,
