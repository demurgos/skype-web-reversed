define("ui/viewModels/chat/pes.v2/store/browseTabs", [
  ...
  function p(e, p) {
    ...
    function S(t) {
      ...
      d.showTabList(!0);
      d.selectedTab(t);
      g.scrollToElement(i.getElement(".store-tab-item-details", e));
    }
    function x() {
      d.showSpinner(!0);
      d.showErrorText(!1);
    ...
    function T(e) {
      ...
      w.indexOf(e.id) !== -1 && e.isDownloaded(!0);
    }
    function N() {
      d.tabs().length || x();
      w = d.pickerState && d.pickerState.purchasedTabIds ? d.pickerState.purchasedTabIds : [];
      y.loadCatalog().then(function (e) {
        var t, n;
        E();
        ...
        d.showSpinner(!1);
        d.tabs().length || d.showErrorText(!0);
      });
    }
    function C(e) {
    ...
    function k(e) {
      ...
      f.putNewPurchasedTab.run(d.pickerState, e.id, t);
      l.mruStateUpdater.run(d.pickerState);
      d.pickerVM.applyState(d.pickerState);
    ...
    function A(e) {
      t.remove(d.pickerState.tabs, { id: e.id });
      l.mruStateUpdater.run(d.pickerState);
    }
    ...
    m.init();
    g.init();
    d.showSpinner = n.observable(!1);
    d.showErrorText = n.observable(!1);
    d.showTabList = n.observable(!1);
    d.showTabDetails = n.observable(!1);
    d.tabs = n.observableArray();
    d.selectedTab = n.observable(!1);
    d.searchQuery = n.observable("");
    p && (d.modalDialog = p.storeModalDialog || !1, d.pickerVM = p.pickerVM || !1, d.pickerState = p.pickerState || !1);
    d.showStore = function () {
      d.modalDialog && (d.modalDialog.show("pes-store-comp"), m.adjustToRTLLayout(), g.adjustToRTLLayout(), N());
    };
    d.pickerState && (d.pickerState.showStore = d.showStore);
    d.tabSelected = function (e) {
    ...
    d.onSearchBoxKeyDown = function (e, t) {
