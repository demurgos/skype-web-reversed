define("ui/viewModels/chat/spaceSettings", [
  ...
  function l(e, t) {
    ...
    function c() {
      r.role = u.newObservableProperty(e.selfParticipant.role), r.spaceLink = u.newObservableProperty(e.uri), r.joiningEnabled(e.isJoiningEnabled()), e.isJoiningEnabled.get(function (e) {
        r.joiningEnabled(e), r.dispatchEvent(a.conversation.JOINING_ENABLED, e, r.DIRECTION.PARENT);
      });
    }
    var r = this;
    r.role = n.observable(s.participantRole.Leader), r.spaceLink = n.observable(), r.joiningEnabled = n.observable(!!t), r.registerEvent(a.newConversation.CANCELLED, l), r.registerEvent(a.newConversation.CONFIRMED, l), e.selfParticipant && c(), r.label = n.pureComputed(function () {
