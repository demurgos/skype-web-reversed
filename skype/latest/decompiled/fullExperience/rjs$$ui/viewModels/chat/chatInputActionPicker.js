define("ui/viewModels/chat/chatInputActionPicker", [
  ...
  function p(e) {
    ...
    t.__internal = { isGuestUser: r.isGuest.bind(null, n.get().personsAndGroupsManager.mePerson) };
    t.isActionPickerOpened = s.observable(!1);
    t.isActionPickerCollapsed = s.observable(!1);
    t.conversationModel = e.conversationModel;
    t.isDisabled = e.isDisabled;
    t.mediaPickerTelemetryEvent = a.build();
    t.isPollsFeatureEnabled = s.observable(!1);
    t.init = function () {
      t.registerEvent(u.events.mediaPicker.CLOSE_PICKER, E);
      t.forwardEvent(u.events.mediaPicker.POLL_BUTTON_SELECTED, t.DIRECTION.CHILD);
      l.get().currentMode() === c.WIDE && x();
      m = l.get().currentMode.subscribe(function (e) {
        e === c.WIDE ? x() : T();
      });
    ...
    t.triggerActionMenu = function () {
      t.isActionPickerOpened(!t.isActionPickerOpened());
      t.isActionPickerOpened() && (t.isActionPickerCollapsed(!1), t.mediaPickerTelemetryEvent.data.paperclipButtonClicked = !0);
    };
