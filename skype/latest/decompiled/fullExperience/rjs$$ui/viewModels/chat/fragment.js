define("ui/viewModels/chat/fragment", [
  ...
  function s(e) {
    ...
    this.name = e.page;
    this.options = e;
    this.hidden = n.observable(!0);
    this.setVisible = function (e) {
      this.dispatchEvent(e ? r.FRAGMENT_BEFORE_SHOW : r.FRAGMENT_BEFORE_HIDE, this.options, this.DIRECTION.CHILD);
      this.hidden(!e);
      this.dispatchEvent(e ? r.FRAGMENT_SHOW : r.FRAGMENT_HIDE, this.options, this.DIRECTION.CHILD);
    };
