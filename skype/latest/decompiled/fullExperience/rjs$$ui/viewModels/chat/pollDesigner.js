define("ui/viewModels/chat/pollDesigner", [
  ...
  function v(e, i, v) {
    ...
    m.isDisabled = e;
    m.isOpened = n.observable(!1);
    m.questionText = n.observable("");
    m.answers = n.observableArray();
    m.isMultipleChoice = n.observable(!1);
    m.isSendButtonEnabled = n.computed(function () {
      var e = !0, n = m.answers();
    ...
    m.init = function () {
      m.initPollBubble();
      m.registerEvent(f.events.mediaPicker.POLL_BUTTON_SELECTED, N);
    };
    m.initPollBubble = function () {
      m.questionText("");
      v.initPollQuestion();
      m.isMultipleChoice(!1);
      m.answers.removeAll();
      m.addNewAnswer("", !0, !1);
      m.addNewAnswer("", !1, !1);
    };
    ...
    m.submitPoll = function () {
      ...
      var e = {};
      e.question = y;
      e.answers = t.map(g, function (e) {
        return e.value();
      });
      e.multipleChoice = m.isMultipleChoice();
