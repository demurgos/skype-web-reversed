define("ui/viewModels/chat/videoPlayer", [
  ...
  function l(e, t) {
    ...
    function w(e) {
      ...
      l.currentTime = l.duration * (r / t), b(r / t * 100);
    }
    function E() {
      n.isInFullscreen(i.fullscreenElement || i.mozFullscreenElement || i.webkitFullscreenElement), n.isInFullscreen() || n.dispatchEvent(o.events.videoPlayer.FULLSCREEN_OFF, null, n.DIRECTION.PARENT);
    }
    function S() {
    ...
    n.media = t.media, n.poster = t.poster, n.autoplay = t.autoplay || !1, n.isPlaying = u.observable(!1), n.isInFullscreen = u.observable(!1), n.isFullscreenSupported = s.requestFullscreen || s.mozRequestFullScreen || s.webkitRequestFullScreen || s.msRequestFullScreen, n.currentProgress = u.observable("0"), n.currentTime = u.pureComputed(function () {
      ...
      h = !0, v(l.currentTime), m(l.duration), f.sendLoadedEvent();
    }, n.onTimeUpdated = function () {
      v(l.currentTime), b(v() / m() * 100);
      ...
      function n() {
        i.removeEventListener("mousemove", w), i.removeEventListener("mouseup", n);
      }
      w(t), i.addEventListener("mousemove", w), i.addEventListener("mouseup", n), T();
    }, n.init = function () {
      n.autoplay && n.isPlaying(!0), i.addEventListener("webkitfullscreenchange", E), i.addEventListener("mozfullscreenchange", E), i.addEventListener("MSFullscreenChange", E), i.addEventListener("fullscreenchange", E);
    }, n.dispose = function () {
      n.currentTime.dispose(), n.totalTime.dispose(), n.playButtonText.dispose(), n.fullscreenButtonText.dispose(), i.removeEventListener("webkitfullscreenchange", E), i.removeEventListener("mozfullscreenchange", E), i.removeEventListener("MSFullscreenChange", E), i.removeEventListener("fullscreenchange", E);
    };
  }
