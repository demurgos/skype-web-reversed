define("ui/viewModels/chat/conversationShareLink", [
  ...
  function c(e) {
    function p() {
      t.isTooltipOpened(!0), f.add("conversationShareLink", d), h.recordAction(a.invites.shareButton, e.telemetryContext);
    }
    function d() {
      t.isTooltipOpened(!1), f.remove("conversationShareLink");
    }
    function v() {
    ...
    t.isTooltipOpened = r.observable(!1), t.conversationModel = e.conversationModel, t.isJoiningEnabled = t.conversationModel.isJoiningEnabled ? o.newObservableProperty(t.conversationModel.isJoiningEnabled) : r.observable(!0), t.telemetryContext = e.telemetryContext, t.share = function () {
      t.isJoiningEnabled() && !v() && t.dispatchEvent(l.conversation.SHARED, function (e) {
        t.conversationModel = e, t.isJoiningEnabled(c), t.conversationModel.uri.get();
      }), p();
      ...
      t.dispatchEvent(l.conversation.OPEN_PROFILE, { editTopic: !1 }, t.DIRECTION.PARENT), d();
    }, t.dispose = function () {
      t.isTooltipOpened() && d();
    };
  }
