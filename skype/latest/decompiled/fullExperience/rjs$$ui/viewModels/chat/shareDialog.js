define("ui/viewModels/chat/shareDialog", [
  ...
  function u(e, t) {
    ...
    function l(e, t) {
      var n = e.chatService;
      t = t.trim();
      t.length > 0 && n.sendMessage(t);
      s.sharedUrl && n.sendMessage(s.sharedUrl);
    }
    var s = this, u = [];
    s.sharedUrl = e;
    s.flowId = t;
    s.isHidden = r.observable(!0);
    s.show = function () {
      s.isHidden(!1);
    };
    s.dispose = function () {
    };
    s.shareButtonEnabled = r.observable(!0);
    s.chatInputAsync = new Promise(function (e) {
