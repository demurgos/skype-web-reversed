define("ui/viewModels/chat/contactPickerInput", [
  ...
  function m() {
    ...
    function S() {
      t.focus(), f.execute(m.scrollToBottom);
    }
    function x() {
      e.inputValue(d), e.showMoreResultsAvailableMessage(!1);
    }
    var e = this, t = null, r = null, m;
    e.selectedContacts = n.observableArray(), e.placeholder = n.computed(function () {
