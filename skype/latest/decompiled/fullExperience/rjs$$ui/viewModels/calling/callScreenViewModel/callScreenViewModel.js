define("ui/viewModels/calling/callScreenViewModel/callScreenViewModel", [
  ...
  function S(e) {
    ...
    function L() {
      var e = !0;
      l.addParticipantMode(e);
      l.dispatchEvent(a.events.callScreen.ADD_PARTICIPANT_VISIBLE, e, l.DIRECTION.CHILD);
    }
    function A() {
      var e = !1;
      l.addParticipantMode(e);
    ...
    function O() {
      l.dispatchEvent(a.events.callScreen.SIDEBAR_TOGGLED, l.DIRECTION.CHILD);
      c.refresh();
    }
    function M(e) {
    ...
    function _() {
      l.addClassToShowSidebar() ? (v.publish(E.HIDE_SIDEBAR), l.addClassToShowSidebar(!1), l.addClassToHideSidebar(!0)) : (v.publish(E.SHOW_SIDEBAR), l.addClassToShowSidebar(!0), l.addClassToHideSidebar(!1));
      P();
    }
    function D(e) {
      l.isContainerFullScreen(e);
      c.refresh();
      e && t && l.bottomValueInPixels(t);
    }
    function P() {
    ...
    function B(e) {
      l.isConversationVisible(e);
      e && c.refresh();
    }
    function j() {
      v.publish(E.SHOW_SIDEBAR);
      l.dispatchEvent(o.EVENTS.CALL_SCREEN_CLOSE, l.DIRECTION.PARENT);
      l.dispose();
    }
    function F() {
      b = d.setTimeout(q, w);
    ...
    this.conversation = e;
    this.callingState = x;
    this.isContainerFullScreen = p.observable(!1);
    this.bottomValueInPixels = p.observable("0%");
    this.avatarUrl = i.newObservableProperty(e.avatarUrl);
    this.addClassToShowSidebar = p.observable(!0);
    this.addClassToHideSidebar = p.observable(!1);
    this.controlsVisible = p.observable(!0);
    this.isConversationVisible = p.observable(!0);
    this.isResizeVisible = N.isFeatureOn(o.FEATURE_FLAGS.RESIZE_CALL_AND_CHAT);
    this.footerButtonsWidth = p.observable(0);
    this.addParticipantMode = p.observable(!1);
    this.addParticipantsTitle = h.fetch({ key: "button_text_addParticipants" });
    this.cancelAddParticipantsTitle = h.fetch({ key: "button_text_cancelAddParticipants" });
    this.setParticipantProvider = function (e) {
      S = e;
    };
    this.submitSelectedParticipants = function () {
      var t = S.selectedContacts;
      t().length > 0 && (e.isGroupConversation() || l.dispatchEvent(a.events.callScreen.CALL_ESCALATED_TO_GROUP, !0, l.DIRECTION.CHILD), k(e.isGroupConversation()), u.addPersonsToConversation(t(), e));
      C();
    };
    this.undoSelectedParticipants = C;
    this.callStatusScreenReader = p.computed(function () {
      var t = T();
      if (t === s.ENDING)
    ...
    this.mainClass = p.computed(U);
    this.isContainerFullScreen.subscribe(function (e) {
    ...
    this.init = function () {
      m.init(x);
      T.subscribe(H);
      l.registerEvent(a.events.callScreen.ADD_PARTICIPANT, L);
      l.forwardEvent(a.events.roster.ROSTER_QUERY_CHANGED);
      l.forwardEvent(a.events.roster.ROSTER_QUERY_EXECUTED);
      l.forwardEvent(a.events.roster.ROSTER_SELECTION_REMOVED);
      l.forwardEvent(a.events.roster.PICKER_CONTACT_SELECTED);
      l.forwardEvent(a.events.roster.PICKER_CONTACT_DESELECTED);
      l.registerEvent(a.events.callScreen.BUTTONS_WIDTH_CHANGED, l.footerButtonsWidth.bind(l));
      l.registerEvent(a.events.callScreen.TOGGLE_NARROW_MENU, _);
      l.registerEvent(a.events.callScreen.BUTTON_FOCUSED, M);
      l.forwardEvent(a.events.callScreen.TOGGLE_FULLSCREEN, l.DIRECTION.CHILD, D);
      l.forwardEvent(a.events.navigation.FRAGMENT_SHOW, l.DIRECTION.CHILD, B.bind(l, !0));
      l.forwardEvent(a.events.navigation.FRAGMENT_BEFORE_HIDE, l.DIRECTION.CHILD, B.bind(l, !1));
      r.getBrowserInfo().browserName === r.BROWSERS.SKYPE_SHELL && l.isContainerFullScreen(!0);
      e.autoCall && e.autoCall() && l.isContainerFullScreen(!0);
      A();
      c.refresh();
      v.subscribe(E.SIDEBAR_TRANSITION_ENDED, O);
    };
    this.dispose = function () {
      m.dispose();
      l.isContainerFullScreen(!1);
      x.dispose();
      l.mainClass.dispose();
      l.callStatusScreenReader.dispose();
      v.unsubscribe(E.SIDEBAR_TRANSITION_ENDED, O);
    };
  }
