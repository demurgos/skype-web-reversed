define("ui/viewModels/calling/callScreenViewModel/callScreenFooterViewModel", [
  ...
  function v(e, t) {
    ...
    a.endCallControl = l.build(e, !0);
    a.micControl = h.build(e, !0);
    a.videoControl = p.build(e, !0);
    a.moreActionsControl = c.build(e);
    a.moreActionsControl.setContext(a);
    a.showDialpadControl = r.observable(y);
    a.showVideoControl = E();
    a.isLocalEscalationEnabled = b();
    a.isScreenSharingEnabled = w();
    a.hasMoreThanOneMoreAction = a.isLocalEscalationEnabled && a.isScreenSharingEnabled;
    y && (a.dialpadControl = d.build(e));
    a.view = null;
    a.onButtonFocused = function () {
    ...
    a.init = function (e) {
      a.view = e;
      a.view.init(S);
      a.dialpadControl && a.dialpadControl.init(i.getElement(".DialPadController-input", t));
      a.forwardEvent(o.events.callScreen.CALL_ESCALATED_TO_GROUP, a.DIRECTION.CHILD);
      a.forwardEvent(o.events.callScreen.ADD_PARTICIPANT, a.DIRECTION.PARENT);
      a.forwardEvent(o.events.callScreen.ADD_PARTICIPANT_VISIBLE, a.DIRECTION.CHILD);
      S();
    };
    a.dispose = function () {
      a.view && a.view.dispose();
      a.endCallControl.dispose();
      a.micControl.dispose();
      a.videoControl.dispose();
      a.moreActionsControl.dispose();
      a.dialpadControl && a.dialpadControl.dispose();
    };
  }
