define("ui/viewModels/calling/callScreenViewModel/participantViewModel", [
  ...
  function c(e) {
    ...
    function C(e) {
      ...
      t.isConnecting(n), t.isDisconnecting(r);
    }
    function k(n) {
      e.isGroupConversation && n.audio.isSpeaking.changed(t.isSpeaking), n.audio.state.changed(C), n.video.channels.added(O), n.video.channels.removed(M), t.isScreenSharing && _(n.screenSharing.stream), v = t.videoElement.subscribe(D);
    }
    function L(n) {
    ...
    function O(e) {
      g = e, t.isScreenSharing || (!t.isSelfParticipant && t.isGroupConversation && A(g, t.videoIsAllowed()), _(g.stream));
    }
    function M() {
      t.dispose();
    }
    function _(e) {
      a = e, D(t.videoElement()), P(a), a.state.changed(c);
    }
    function D(e) {
      if (a) {
    ...
    t.participant = r.observable(), t.isSelfParticipant = Boolean(e.isSelfParticipant), t.isGroupConversation = Boolean(e.isGroupConversation), t.isScreenSharing = Boolean(e.isScreenSharing), t.videoIsAllowed = e.videoIsAllowed, t.isVisible = e.isVisible, t.isZoomedIn = r.observable(!1), t.videoElement = r.observable(), t.isSpeaking = r.observable(!1), t.isFocused = r.observable(), t.avatarVisible = r.computed(function () {
    ...
    }), t.isConnecting = r.observable(!1), t.isDisconnecting = r.observable(!1), t.init = function () {
      p = t.participant.subscribe(k), d = t.participant.subscribe(L, this, "beforeChange"), m = t.isVisible.subscribe(N), t.participant(e.participant), t.isVisible(e.isVisible), h = c.subscribe(T), t.avatarVisible.subscribe(S), t.isZoomedIn.subscribe(x), y = t.videoIsAllowed.subscribe(E);
    }, t.toggleZoom = function () {
      var e = l.resolve(s.serviceLocator.ACTION_TELEMETRY);
      t.isZoomedIn(!t.isZoomedIn()), e.recordAction(f.audioVideo.zoomInOut);
      ...
      L(t.participant()), E(!1), g && ((t.isSelfParticipant || t.isGroupConversation) && A(g, !1), g = null), a && (a.source.sink.container(null), a.state.changed.off(c), a = null), v && v.dispose(), h && h.dispose(), p && p.dispose(), d && d.dispose(), m && m.dispose(), y && y.dispose(), t.avatarVisible.dispose(), t.isVideoLoading.dispose();
    };
  }
  ...
  n.assign(c.prototype, a), t.build = function (e) {
    return new c(e);
  };
})
