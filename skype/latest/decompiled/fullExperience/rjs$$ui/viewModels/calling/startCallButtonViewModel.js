define("ui/viewModels/calling/startCallButtonViewModel", [
  ...
  function l(e) {
    function c() {
      n.callButtonViewModel.conversationModel.participants.changed.off(p);
      t = null;
    }
    function h() {
    ...
    function p() {
      h();
      n.callButtonViewModel.isOneToOneConversation() && (t = n.callButtonViewModel.participantPerson(), t.phoneNumbers.changed(d));
    }
    function d() {
    ...
    n.callButtonViewModel = e.callButtonViewModel;
    n.phoneNumbers = i.observable([]);
    n.callButtonViewModel.conversationModel.participants.changed(p);
    n.getMenuOptions = function () {
