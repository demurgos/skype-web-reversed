define("ui/viewModels/calling/plugin/unblockStepViewModel", [
  ...
  var n = e("cafe/applicationInstance"), r = e("ui/viewModels/calling/helpers/browserInstallContent"), i = e("swx-enums"), s = e("swx-i18n").localization, o = e("constants/calling"), u = function (u) {
      ...
      this.id = t.STEP_ID, this.label = s.fetch({ key: "pluginInstall_label_text_unblock" }), this.unblockText = l.text.unblock, this.unblockImageUrl = l.images.unblock, this.isFirefox = u.isFirefox, this.show = function () {
        h();
      }, this.close = function () {
        f();
      };
    };
  t.STEP_ID = o.CALLING_SETUP_STEPS.OVERLAY_PLUGIN_UNBLOCK, t.build = function (e) {
    return new u(e);
  };
})
