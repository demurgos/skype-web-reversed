define("ui/viewModels/commerce/subscriptionEntitlement", [
  ...
  function c() {
    ...
    e.showSubscriptionsText = r.observable(!1);
    e.subscriptionsText = r.computed(h);
    e.purchaseSubscriptionUrl = o.commerce.purchaseSubscriptionUrl;
    t.entitlements.get().then(function () {
