define("ui/contextMenu/items/removeContactFromFavorites", [
  "require",
  "lodash-compat",
  "experience/settings",
  "swx-i18n",
  ...
  function h() {
    return r.fetch({ key: "favorites_remove_from_favorite" });
  }
  function p(e, r) {
    function v() {
      a.removeFavorite(d);
  ...
  return p.prototype = Object.create(i.prototype), p.TYPE = "RemoveFromFavoritesMenuItem", p;
});
