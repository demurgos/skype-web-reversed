define("ui/contextMenu/items/removeGroupConversationFromFavorites", [
  "require",
  "experience/settings",
  "swx-i18n",
  ...
  function f(e, n) {
    function l() {
      e._isFavorited && e._isFavorited(!1);
      c();
    }
    function c() {
    ...
    this.isEnabled = function () {
      var t = i.resolve(s.serviceLocator.FEATURE_FLAGS).isFeatureOn(s.featureFlags.FAVORITES_CONVERSATION_ENABLED), n = !!e._isFavorited && e._isFavorited();
      return t && n;
    };
  }
