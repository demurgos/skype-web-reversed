define("ui/telemetry/chat/guestActionsInHeader", [
  ...
  function h() {
    ...
    function c() {
      s.mark(f.CONVERSATION.TTP), s.measure(l.EXPERIENCE.TTL, f.EXPERIENCE.TTL_START, f.CONVERSATION.TTP);
    ...
    return e.onProfileToggled = function (e) {
      e.cta = a.cta.PROFILE_TOGGLED, e.telemetryItem === a.telemetryItem.AVATAR ? e.cta = 1 : e.telemetryItem === a.telemetryItem.TOPIC ? e.cta = e.groupProfileExpanded ? 3 : 2 : e.telemetryItem === a.telemetryItem.CHEVRON_DOWN ? e.cta = 4 : e.telemetryItem === a.telemetryItem.CHEVRON_UP && (e.cta = 5), t(e);
    }, e.onCopyLinkClicked = function (e) {
      e.cta = a.cta.COPY_LINK, e.parent === a.parent.GROUP_PROFILE_VIEW_MODEL ? e.cta = 6 : e.parent === a.parent.HEADER_VIEW_MODEL && (e.cta = 7), t(e);
    }, e.onEmailLinkClicked = function (e) {
      e.cta = a.cta.EMAIL_LINK, e.parent === a.parent.GROUP_PROFILE_VIEW_MODEL ? e.cta = 8 : e.parent === a.parent.HEADER_VIEW_MODEL && (e.cta = 9), t(e);
