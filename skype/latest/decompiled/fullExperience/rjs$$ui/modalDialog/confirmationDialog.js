define("ui/modalDialog/confirmationDialog", [
  ...
  function l(e) {
    ...
    t.title = s.unboxHrefContent(e.title);
    t.text = e.text;
    t.content = e.content;
    t.contentViewModel = e.contentViewModel;
    t.avatar = e.avatar;
    t.confirmButtonTitle = e.confirmButtonTitle || i.fetch({ key: "action_button_confirm" });
    t.cancelButtonTitle = e.cancelButtonTitle || i.fetch({ key: "action_button_cancel" });
    t.isGroupConversation = o.observable(e.isGroupConversation || !1);
    t._cancel = function () {
      r.hide(f);
      l && l();
    };
