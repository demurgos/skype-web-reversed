  ...
  function p() {
    function v(t) {
      ...
      r.audioHandler = function (n, r, o) {
        ...
        o && (g(t, n), y(t, n)), r === i.callDisconnectionReason.OutOfBrowserCall && l.addP2PConversation(t), n === i.callConnectionState.Disconnected && (l.init(), e.activeCalls.remove(t));
      }, r.videoHandler = function (e) {
        y(t, e);
      }, r.participantsSubs = [], r.participantAddedHandler = function (n) {
        ...
        s.participant = n, o.participant = n, r.participantsSubs.push(s, o);
      ...
      }, t.participants.added(r.participantAddedHandler), t.participants.removed(r.participantRemovedHandler), t.selfParticipant.audio.state.changed(r.audioHandler), t.selfParticipant.video.state.changed(r.videoHandler), t.spawnedConversation && t.spawnedConversation.changed(r.spawnedConversationStateChanged);
    }
    function m(e, t) {
    ...
    function b(e, t) {
      e.screenSharingService.sharer(t), e.screenSharingService.accept.enabled() && e.screenSharingService.accept();
    }
    function w(t) {
      var n = E(t);
    ...
    e.activeCalls = r.observableArray(), e.observe = function (e) {
      t = e.conversationsManager.conversations, t.added(v), t.removed(w), d.init();
    };
  }
