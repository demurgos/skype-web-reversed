define("ui/components/chat/pes/localSearchTab/localSearchTab", [
  "require",
  "lodash-compat",
  "swx-constants",
  "swx-i18n",
  ...
  function h(e, r, o) {
    var a = t.find(r.tabs, { id: i.localSearch.TAB_ID }), f = s.resolve(n.serviceLocator.PES_CONFIG_SERVICE), h = f.getConfiguration();
    e = (e || "").toLowerCase();
    a._currentQuery = e;
    e ? l(h, e, r, a) : c(r, a);
  ...
  var t = e("lodash-compat"), n = e("swx-constants").COMMON, r = e("swx-i18n").localization, i = e("services/pes/constants"), s = e("swx-service-locator-instance").default, o = e("experience/settings"), u = e("services/pes/interactors/picker"), a = e("services/pes/interactors/localSearch");
