define("ui/components/chat/pes.v2/expressionPickerController", [
  ...
  return m.prototype.init = function (e, s) {
    ...
    this.model.selectedTab.id === f.bingSearch.TAB_ID && (n.highlightTabOnBingKeywords(this.model._chatInputText, this.model, this.viewModel.applyState.bind(this.viewModel)), g(this));
    this.model.selectedTab.id === f.localSearch.TAB_ID && b(this);
    ...
    this.model.isOpened ? (this.stopPlaybackAction(), this.model.isOpened = !1) : (this.model.isOpened = !0, this.model.wasOpenedBefore = !0, this.activateTab(this.model.selectedTab.id));
    this.viewModel.applyState(this.model);
