define("ui/components/userSettings/userSettingsPage", [
  ...
  t.name = e("constants/components").userSettings.USER_SETTINGS_PAGE;
  t.template = e("text!views/userSettings/userSettingsPage.html");
  t.viewModel = { createViewModel: n.build.bind(n) };
});
