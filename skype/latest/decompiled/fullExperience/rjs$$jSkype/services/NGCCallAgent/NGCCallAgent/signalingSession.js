define("jSkype/services/NGCCallAgent/NGCCallAgent/signalingSession", [
  ...
  var n = e("jSkype/services/NGCCallAgent/NGCCallAgent/constants"), r = e("jSkype/services/NGCCallAgent/NGCCallAgent/telemetryConstants"), i = e("jSkype/services/NGCCallAgent/NGCCallAgent/participant"), s = e("jSkype/services/NGCCallAgent/NGCCallAgent/utils"), o = e("jSkype/services/serviceAccessLayer/requestDispatcher"), u = e("jSkype/services/NGCCallAgent/NGCCallAgent/requestBuilder"), a = e("jSkype/services/NGCCallAgent/NGCCallAgent/createConversationRequest"), f = e("jSkype/services/NGCCallAgent/NGCCallAgent/joinGivenConversationRequest"), l = e("jSkype/services/NGCCallAgent/NGCCallAgent/joinGivenConversationWithoutCallModalityRequest"), c = e("jSkype/services/NGCCallAgent/NGCCallAgent/leaveConversationRequest"), h = e("jSkype/services/NGCCallAgent/NGCCallAgent/cancelCallRequest"), p = e("jSkype/services/NGCCallAgent/NGCCallAgent/endCallRequest"), d = e("jSkype/services/NGCCallAgent/NGCCallAgent/provisionalMediaResponse"), v = e("jSkype/services/NGCCallAgent/NGCCallAgent/callAcceptanceRequest"), m = e("jSkype/services/NGCCallAgent/NGCCallAgent/rejectCallRequest"), g = e("jSkype/services/NGCCallAgent/NGCCallAgent/joinConversationForConnectedCallRequest"), y = e("jSkype/services/NGCCallAgent/NGCCallAgent/attachCallRequest"), b = e("jSkype/services/NGCCallAgent/NGCCallAgent/callProgressRequest"), w = e("jSkype/services/NGCCallAgent/NGCCallAgent/callAcceptanceAcknowledgementRequest"), E = e("jSkype/services/NGCCallAgent/NGCCallAgent/participantUpdateRequest"), S = e("jSkype/services/NGCCallAgent/NGCCallAgent/updateParticipantConversationLinksRequest"), x = e("jcafe-property-model"), T = e("jSkype/settings"), N = e("constants/common"), C = e("swx-utils-common").stopwatch, k = e("jSkype/services/NGCCallAgent/NGCCallAgent/telemetryHelper"), L = e("jSkype/services/NGCCallAgent/NGCCallAgent/participantManager"), A = e("jSkype/services/NGCCallAgent/NGCCallAgent/mediaRenegotiationManager"), O = e("jSkype/services/NGCCallAgent/NGCCallAgent/timeoutManager"), M = function (e, t, M, _, D) {
      function $(e) {
        F = !0;
        H[n.LINKS.CONVERSATION_CONTROLLER] = e.conversationController;
        H[n.LINKS.ADD_PARTICIPANT_AND_MODALITY] = e.links.addParticipantAndModality;
        H[n.LINKS.LEAVE] = e.links.leave;
        H[n.LINKS.NOTIFICATION_LINKS] = e.links.notificationLinks;
        H[n.LINKS.REMOVE_PARTICIPANT] = e.links.removeParticipant;
        P.convSubject = e.subject;
        e.activeModalities && e.activeModalities.groupChat && (P.threadId = e.activeModalities.groupChat.threadId, e.activeModalities.groupChat.messageId && (P.spacesMessageId = e.activeModalities.groupChat.messageId));
        e.state && (P.multiParty = e.state.isMultiParty);
      }
      function J(e) {
        var t = x.task(), i = e || {
        ...
        if (!H.hasOwnProperty(n.LINKS.LEAVE))
          ...
          X.log("cancelling outgoing call");
          ...
          u.get(P, r.NETWORK_REQUESTS.CANCEL_CALL, f).then(function (e) {
            ...
            I || (P.telemetryHelper.setTerminatingData({
              ...
              endCode: n.CALL_END_CODE.CANCEL
            }), P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.CANCEL_CALL, !0, a.duration()), bt(), Y(n.CALL_STATUS.LOCAL_TERMINATED, i));
            s.safelyResolvePromise(t, e.response);
          }).catch(function (e) {
            var o = s.getPrintableObject(e);
            X.error("Cancelling call failed because : " + o);
            I || (P.telemetryHelper.setTerminatingData({
              terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
              endCode: n.CALL_END_CODE.CANCEL,
              endSubCode: n.CALL_END_SUB_CODE.FAILED_TO_REACH_SERVICE,
              resultDetail: "Failed to Cancel Call. Error = " + o
            }), P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.CANCEL_CALL, !1, a.duration()), bt(), i.subCode = n.CALL_END_SUB_CODE.FAILED_TO_REACH_SERVICE, Y(n.CALL_STATUS.LOCAL_TERMINATED, i));
            s.safelyResolvePromise(t, null);
          });
        }
        return t.promise;
      }
      function K(e) {
        ...
        return Q(u).then(function (e) {
          I || (P.telemetryHelper.setTerminatingData({ terminatingEnd: r.CALL_TERMINATING_END.LOCAL }), P.telemetryHelper.addNetworkOperationCompleted(i, !0, o.duration()), bt(), Y(n.CALL_STATUS.LOCAL_TERMINATED, u));
          s.safelyResolvePromise(t, e.response);
        }).catch(function (e) {
          var a = s.getPrintableObject(e);
          X.error("Ending call failed because : " + a);
          I || (P.telemetryHelper.setTerminatingData({
            terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
            endCode: n.CALL_END_CODE.SUCCESS,
            endSubCode: n.CALL_END_SUB_CODE.FAILED_TO_REACH_SERVICE,
            resultDetail: "Failed to end Call. Error = " + a
          }), P.telemetryHelper.addNetworkOperationCompleted(i, !1, o.duration()), bt(), u.subCode = n.CALL_END_SUB_CODE.FAILED_TO_REACH_SERVICE, Y(n.CALL_STATUS.LOCAL_TERMINATED, u));
          s.safelyResolvePromise(t, null);
        }), t.promise;
      }
      function Q(e) {
      ...
      function G(e) {
        ...
        return u.get(P, r.NETWORK_REQUESTS.REJECT_CALL, f).then(function (e) {
          ...
          }), P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.REJECT_CALL, !0, a.duration()), bt(), Y(n.CALL_STATUS.LOCAL_TERMINATED, i));
          s.safelyResolvePromise(t, e.response);
        }).catch(function (e) {
          var o = s.getPrintableObject(e);
          X.error("reject failed because : " + o);
          I || (P.telemetryHelper.setTerminatingData({
            terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
            endCode: n.CALL_END_CODE.REJECT,
            endSubCode: n.CALL_END_SUB_CODE.FAILED_TO_REACH_SERVICE,
            resultDetail: "Failed to reject call. Error = " + o
          }), P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.REJECT_CALL, !1, a.duration()), bt(), Y(n.CALL_STATUS.LOCAL_TERMINATED, i));
          s.safelyResolvePromise(t, null);
        }), t.promise;
      }
      function Y(e, n) {
        X.log("CallStatus changed : " + B + " => " + e);
        n && X.log("onCallStatusChanged: statusCode = " + s.getPrintableObject(n));
        Z(e) > Z(B) && (B = e, t.onCallStatusChanged(e, n));
      }
      function Z(e) {
        switch (e) {
      ...
      function et(e) {
        X.log("handleCallAcceptanceAck called");
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_CALL_ACCEPTANCE_ACK);
        ...
        H[n.LINKS.TRANSFER] = e.callAcceptanceAcknowledgement.links.transfer;
        H[n.LINKS.REPLACE] = e.callAcceptanceAcknowledgement.links.replacement;
        H[n.LINKS.HANGUP] = e.callAcceptanceAcknowledgement.links.callLeg;
        H[n.LINKS.KEEPALIVE] = e.callAcceptanceAcknowledgement.links.callLeg;
        vt(e.callAcceptanceAcknowledgement.callKeepAliveInterval);
        j = n.SIGNALING_FSM_STATE.CONNECTED;
        P.timeoutManager.stopTimer(n.TIMEOUT_OPERATIONS.INCOMING_CALL_ESTABLISHMENT);
        P.telemetryHelper.startCallConnectedWatch();
        P.mediaRenegotiationManager.onCallConnected();
        ...
        u.get(P, r.NETWORK_REQUESTS.JOIN_CONVERSATION, i).then(function (e) {
          ...
          if (!I) {
            ...
            P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.JOIN_CONVERSATION, !0, t.duration());
            $(e.response);
            P.participantManager.handleRosterUpdate(e.response.roster);
          }
        }).catch(function (e) {
          var n = s.getPrintableObject(e);
          X.error("ConversationJoin failed because : " + n);
          X.log("current call status : " + B);
          I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.JOIN_CONVERSATION, !1, t.duration());
        });
      }
      function tt(e, t, i, l, c) {
        X.log("placeCall called");
        P.telemetryHelper.setConversationServiceUrl(e.requestUrl);
        P.telemetryHelper.setLocalOfferAnswerDuration(r.LOCAL_OFFER_ANSWER_TIMES.INITIAL_OFFER_TIME + ":" + c);
        z = i;
        W = t;
        P.timeoutManager.startTimer(n.TIMEOUT_OPERATIONS.OUTGOING_CALL_ESTABLISHMENT, yt);
        P.telemetryHelper.setCallerType(P.participantManager.localParticipant.id);
        ...
        u.get(P, r.NETWORK_REQUESTS.PLACE_CALL, p).then(function (t) {
          ...
          X.error("placeCall failed because : " + t);
          I || (j = n.SIGNALING_FSM_STATE.IDLE, P.telemetryHelper.setTerminatingData({
            terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
      ...
      function nt() {
        ...
        if (H.hasOwnProperty(n.LINKS.NOTIFICATION_LINKS)) {
          ...
          u.get(P, r.NETWORK_REQUESTS.UPDATE_CONVERSATION_LINKS, t).then(function (e) {
            ...
            X.error("sending conversation service UpdateNotificationLinks request failed because : " + n);
            I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.UPDATE_CONVERSATION_LINKS, !1, e.duration());
          });
        }
      }
      function rt(e) {
        X.log("awaitCall called");
        P.telemetryHelper.setCalleeType(P.participantManager.localParticipant.id);
      ...
      function it(e) {
        U = i.fromWireParticipant(e.callNotification.from);
        H[n.LINKS.CONVERSATION_CONTROLLER] = e.conversationInvitation.conversationController;
        H[n.LINKS.ATTACH] = e.callNotification.links.attach;
        P.correlationId = e.debugContent.callId;
        P.participantManager.setParticipantId(e.debugContent.participantId);
        P.multiParty = !!e.conversationInvitation.isMultiParty;
        e.groupChat && e.groupChat.threadId && (P.threadId = e.groupChat.threadId, e.groupChat.messageId && (P.spacesMessageId = e.groupChat.messageId));
        Y(n.CALL_STATUS.IDLE);
        st(e);
      }
      function st(e) {
        ...
        u.get(P, r.NETWORK_REQUESTS.SEND_CALL_ATTACH, a).then(function (e) {
          ...
          var t = s.getPrintableObject(e);
          X.error("sendAttachToCall failed because : " + t);
          I || (j = n.SIGNALING_FSM_STATE.IDLE, P.telemetryHelper.setTerminatingData({
            terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
            resultValue: r.RESULT_VALUE.FAILURE,
            endCode: n.CALL_END_CODE.SERVICE_UNAVAILABLE,
      ...
      function ot(e, r) {
        H[n.LINKS.MEDIA_ANSWER] = r.response.callInvitation.links.mediaAnswer;
        H[n.LINKS.ACCEPT] = r.response.callInvitation.links.acceptance;
        H[n.LINKS.REJECT] = r.response.callInvitation.links.callLeg;
        H[n.LINKS.REDIRECT] = r.response.callInvitation.links.redirection;
        ut(r);
        P.telemetryHelper.setCallerType(P.getParticipantIdForOfferAnswer(r.response.callInvitation.mediaContent));
        var i = s.getMediaTypes(r.response.callInvitation.callModalities);
        P.telemetryHelper.addIncomingModalities(i);
        t.onOffer({
      ...
      function ut(e) {
        ...
        u.get(P, r.NETWORK_REQUESTS.SEND_CALL_PROGRESS, n).then(function (t) {
          ...
          var n = s.getPrintableObject(e);
          X.error("sendProgress failed because : " + n);
          I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_CALL_PROGRESS, !1, t.duration());
        });
      }
      function at(e) {
        X.log("handleMediaAnswer called");
        H[n.LINKS.MEDIA_ACKNOWLEDGEMENT] = e.mediaAnswer.links.mediaAcknowledgement;
        if (P.mediaRenegotiationManager.isOutgoingRenegotiationInProgress()) {
          P.mediaRenegotiationManager.handleMediaAnswer(e);
          return;
        }
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_MEDIA_ANSWER);
        j !== n.SIGNALING_FSM_STATE.CONNECTED && j === n.SIGNALING_FSM_STATE.OUTGOING && (P.telemetryHelper.setTimeToRingDuration(), U = e.mediaAnswer.sender, Y(n.CALL_STATUS.RINGING), t.onAnswer({
          provisional: !0,
          renegotiation: !1,
      ...
      function ft(e) {
        X.log("handleCallAcceptance called");
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_CALL_ACCEPTANCE);
        j === n.SIGNALING_FSM_STATE.OUTGOING && (P.telemetryHelper.setTimeToRingDuration(), lt(e));
        ...
        u.get(P, r.NETWORK_REQUESTS.SEND_ACCEPTANCE_ACKNOWLEDGEMENT, i).then(function (t) {
          ...
          var n = s.getPrintableObject(e);
          X.error("handleCallAcceptance failed because : " + n);
          I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_ACCEPTANCE_ACKNOWLEDGEMENT, !1, t.duration());
        });
      }
      function lt(e) {
        j = n.SIGNALING_FSM_STATE.CONNECTED;
        P.timeoutManager.stopTimer(n.TIMEOUT_OPERATIONS.OUTGOING_CALL_ESTABLISHMENT);
        P.telemetryHelper.startCallConnectedWatch();
        P.mediaRenegotiationManager.onCallConnected();
        var r = z, o = s.newGuid();
        e.callAcceptance.acceptedBy && (U = i.fromWireParticipant(e.callAcceptance.acceptedBy), o = e.callAcceptance.acceptedBy.endpointId);
        e.callAcceptance.acceptedCallModalities && e.callAcceptance.acceptedCallModalities.length > 0 && (r = e.callAcceptance.acceptedCallModalities);
        var u = s.getMediaTypes(r);
        P.telemetryHelper.addIncomingModalities(u);
        H[n.LINKS.MEDIA_RENEGOTIATION] = e.callAcceptance.links.mediaRenegotiation;
        H[n.LINKS.TRANSFER] = e.callAcceptance.links.transfer;
        H[n.LINKS.REPLACE] = e.callAcceptance.links.replacement;
        H[n.LINKS.HANGUP] = e.callAcceptance.links.callLeg;
        H[n.LINKS.KEEPALIVE] = e.callAcceptance.links.callLeg;
        vt(e.callAcceptance.callKeepAliveInterval);
        t.onAnswer({
          provisional: !1,
          renegotiation: !1,
          remoteEndpointId: o,
      ...
      function ct(e) {
        X.log("Call End received . Details : " + s.getPrintableObject(e));
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_CALL_END);
        ...
        if (e.code === n.CALL_END_CODE.SUCCESS && e.subCode === n.CALL_END_SUB_CODE.CONVERSATION_RESOLUTION_CONFLICT)
          ...
          bt();
          j = n.SIGNALING_FSM_STATE.IDLE;
          Y(n.CALL_STATUS.REMOTE_TERMINATED, {
            code: e.code,
            subCode: e.subCode,
            phrase: e.phrase
          });
      ...
      function ht(e) {
        X.log("handleConversationResolutionConflict");
        j = n.SIGNALING_FSM_STATE.IDLE;
        P.timeoutManager.stopTimer(n.TIMEOUT_OPERATIONS.OUTGOING_CALL_ESTABLISHMENT);
        P.joinGivenConversation(e.conversationUrl.location, e.correlationId, W, z);
      }
      function pt() {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_CALL_PROGRESS);
        j === n.SIGNALING_FSM_STATE.OUTGOING && (P.telemetryHelper.setTimeToRingDuration(), Y(n.CALL_STATUS.RINGING));
      }
      function dt() {
      ...
      function vt(e) {
        var t = 0.9 * e * 1000;
        X.log("sending KeepAlives every " + t + " milliseconds");
        q = window.setInterval(mt, t);
      }
      function mt() {
        X.log("sendKeepAlive called. Call disposed : " + I);
        if (I)
          return;
        X.log("sending keepAlive count = " + R++);
        gt(u.get(P, r.NETWORK_REQUESTS.SEND_KEEP_ALIVE, null));
      }
      function gt(e) {
        var t = C.build();
        e.then(function (e) {
          ...
          var n = s.getPrintableObject(e);
          X.error("sendToKeepAliveUrl failed because : " + n);
          I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_KEEP_ALIVE, !1, t.duration());
        });
      }
      function yt() {
        X.log("handleCallEstablishmentTimeout");
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_CALL_ESTABLISHMENT_TIMEOUT);
        P.telemetryHelper.setTerminatingData({
          terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
          resultValue: r.RESULT_VALUE.FAILURE,
        ...
        bt();
        j = n.SIGNALING_FSM_STATE.IDLE;
        Y(n.CALL_STATUS.LOCAL_TERMINATED, {
      ...
      P.threadId = null;
      P.multiParty = !1;
      P.spacesMessageId = null;
      P.signalingAgentConfig = M;
      P.urlIdentifier = _;
      P.correlationId = _;
      P.logger = X;
      P.telemetryHelper = new k(P);
      P.mediaRenegotiationManager = new A(P, t);
      P.participantManager = new L(P, t, e);
      P.timeoutManager = new O(P);
      P.isGVCOutgoingEnabled = T.isFeatureOn(N.featureFlags.GVC_OUTGOING);
      P.isGVCJoiningEnabled = T.isFeatureOn(N.featureFlags.GVC_JOINING);
      var V = function () {
        X.log("onTrouterUrlChanged: disposed = " + I);
        if (I)
          return;
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.TROUTER_URL_CHANGED + ":" + M.trouterUrl());
        H.hasOwnProperty(n.LINKS.KEEPALIVE) && (X.log("sending participantUpdateRequest"), gt(u.get(P, "participantUpdateRequest", E.getPayload(P))));
        nt();
      };
      M.trouterUrl.changed(V);
      P.getParticipantIdForOfferAnswer = function (e) {
      ...
      P.setSubject = function (e) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.SET_SUBJECT);
        s.assertNotNull(e, "subject should be a non null value");
        P.convSubject = e;
      };
      ...
      P.setThreadId = function (e, t) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.SET_THREADID);
        s.assertNotNull(e, "threadId should be a non null value");
        s.assert(!P.threadId, "conversation threadId has already been set. It cannot be overwritten");
        P.threadId = e;
        t && (P.spacesMessageId = t);
      };
      ...
      P.startOutgoingCall = function (e, t, i, o) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.START_CALL);
        P.telemetryHelper.setDirection(r.DIRECTION.OUTGOING);
        P.telemetryHelper.setRole(r.ROLE.CALLER);
        P.telemetryHelper.startCallInitializationWatch(o);
        s.assertNotNull(e, "mediaContent should be a non null value");
        s.assertNotNull(e.blob, "outgoingSdp should be a non null value");
        s.assert(j === n.SIGNALING_FSM_STATE.IDLE, "a call is already in progress");
        X.log("startOutgoingCall called");
        j = n.SIGNALING_FSM_STATE.OUTGOING;
        var u = {
          newCall: !0,
      ...
      P.joinGivenConversation = function (e, t, i, o, u) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.JOIN_CALL);
        P.telemetryHelper.setDirection(r.DIRECTION.INCOMING);
        P.telemetryHelper.setRole(r.ROLE.JOIN);
        P.telemetryHelper.startCallInitializationWatch(u);
        s.assertNotNull(i, "mediaContent should be a non null value");
        s.assertNotNull(i.blob, "outgoingSdp should be a non null value");
        s.assertNotNull(t, "correlationId should be a non null value");
        s.assertNotNullOrEmpty(e, "conversationUrl should be a non null value");
        s.assert(j === n.SIGNALING_FSM_STATE.IDLE || j === n.SIGNALING_FSM_STATE.CONNECTED_FOR_ROSTER_ONLY, "a call is already in progress");
        X.log("joinGivenConversation called with url = " + e + " , correlationId = " + t);
        j = n.SIGNALING_FSM_STATE.OUTGOING;
        P.correlationId = t;
        tt({
          newCall: !1,
      ...
      P.joinGivenConversationWithoutCallModality = function (e, t) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.JOIN_CONVERSATION_WITHOUT_CALL_MODALITY);
        P.telemetryHelper.setDirection(r.DIRECTION.INCOMING);
        P.telemetryHelper.setRole(r.ROLE.JOIN_FOR_ROSTER_ONLY);
        s.assertNotNull(t, "correlationId should be a non null value");
        s.assertNotNullOrEmpty(e, "conversationUrl should be a non null value");
        s.assert(j === n.SIGNALING_FSM_STATE.IDLE, "a call is already in progress");
        X.log("joinGivenConversationWithoutCallModality called with url = " + e + " , correlationId = " + t);
        j = n.SIGNALING_FSM_STATE.OUTGOING_FOR_ROSTER_ONLY;
        P.correlationId = t;
        P.telemetryHelper.setConversationServiceUrl(e);
        P.telemetryHelper.setCallerType(P.participantManager.localParticipant.id);
        ...
        u.get(P, r.NETWORK_REQUESTS.JOIN_CONVERSATION_WITHOUT_CALL_MODALITY, a).then(function (t) {
          ...
          if (!I) {
            if (!e.response.roster)
              throw new Error("response does not contain a roster");
            P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.JOIN_CONVERSATION_WITHOUT_CALL_MODALITY, !0, i.duration());
            j = n.SIGNALING_FSM_STATE.CONNECTED_FOR_ROSTER_ONLY;
            $(e.response);
            Y(n.CALL_STATUS.CONNECTED_FOR_ROSTER_ONLY);
            P.participantManager.handleRosterUpdate(e.response.roster);
          }
        }).catch(function (e) {
          var t = s.getPrintableObject(e);
          X.error("joinGivenConversationWithoutCallModality failed because : " + t);
          I || (j = n.SIGNALING_FSM_STATE.IDLE, P.telemetryHelper.setTerminatingData({
            terminatingEnd: r.CALL_TERMINATING_END.LOCAL,
            resultValue: r.RESULT_VALUE.FAILURE,
            endCode: n.CALL_END_CODE.SERVICE_UNAVAILABLE,
      ...
      P.handleIncomingCall = function (e) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_INCOMING_CALL);
        P.telemetryHelper.setDirection(r.DIRECTION.INCOMING);
        P.telemetryHelper.setRole(r.ROLE.CALLEE);
        P.telemetryHelper.startCallInitializationWatch();
        s.assertNotNull(e, "request should be a non null value");
        s.assertNotNullOrEmpty(e.body, "request should have a valid body");
        s.assertNotNullOrEmpty(e.body.gp, "request does not look valid");
        s.assert(j === n.SIGNALING_FSM_STATE.IDLE, "a call is already in progress");
        X.log("handleIncomingCall called");
        j = n.SIGNALING_FSM_STATE.INCOMING;
        P.participantManager.initializeForIncomingCall();
        rt(e);
      };
      ...
      P.handleIncomingMsgAsync = function (e) {
        s.assertNotNull(e, "request should be a non null value");
        X.log("handleIncomingMsg called for url = " + e.url);
      ...
      P.setProvisionalAnswerAsync = function (e, i) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.SET_PROVISIONAL_ANSWER);
        s.assertNotNull(e.blob, "sdp should be a non null value");
        X.log("setProvisionalAnswer called ");
        var a = x.task();
        ...
        return u.get(P, r.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, l).then(function (e) {
          ...
          I || (P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, !0, f.duration()), Y(n.CALL_STATUS.CONNECTING));
          s.safelyResolvePromise(a, e.response);
          I || (X.log("handling inlined mediaAnswerAcknowledgement"), P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.HANDLE_MEDIA_ACKNOWLEDGEMENT), P.telemetryHelper.setTimeToRingDuration(), Y(n.CALL_STATUS.RINGING), t.onMediaAcknowledgementSuccess(!1));
        }).catch(function (e) {
          I || P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, !1, f.duration());
          var t = s.getPrintableObject(e);
          X.error("setProvisionalAnswer failed because : " + t);
          s.safelyRejectPromise(a, new Error("setProvisionalAnswer failed because : " + t));
        }), a.promise;
      };
      ...
      P.acceptAsync = function (e, t, i) {
        P.telemetryHelper.addLocalOperation(r.LOCAL_OPERATIONS.ACCEPT_CALL);
        s.assertNotNull(e, "mediaContent should be a non null value");
        s.assertNotNull(e.blob, "outgoingSdp should be a non null value");
        X.log("accept called");
        var a = x.task();
        ...
        P.telemetryHelper.setLocalOfferAnswerDuration(r.LOCAL_OFFER_ANSWER_TIMES.INITIAL_ANSWER_TIME + ":" + i);
        j = n.SIGNALING_FSM_STATE.WAITING_CALL_ACCEPTANCE_ACK;
        ...
        return u.get(P, r.NETWORK_REQUESTS.SEND_ACCEPTANCE, l).then(function (e) {
          ...
          I || (P.telemetryHelper.addNetworkOperationCompleted(r.NETWORK_REQUESTS.SEND_ACCEPTANCE, !0, f.duration()), B === n.CALL_STATUS.IDLE && (P.telemetryHelper.setTimeToRingDuration(), Y(n.CALL_STATUS.CONNECTING)), e.response.callAcceptanceAcknowledgement && (X.log("handling inlined callAcceptanceAcknowledgement"), et(e.response)));
          s.safelyResolvePromise(a, e.response);
        }).catch(function (e) {
          ...
          var t = s.getPrintableObject(e);
          X.error("accept failed because : " + t);
          s.safelyRejectPromise(a, new Error("accept failed because : " + t));
        }), a.promise;
      };
