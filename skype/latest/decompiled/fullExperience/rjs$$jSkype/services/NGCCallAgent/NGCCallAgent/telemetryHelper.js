define("jSkype/services/NGCCallAgent/NGCCallAgent/telemetryHelper", [
  ...
  var t = e("jSkype/services/NGCCallAgent/NGCCallAgent/constants"), n = e("jSkype/services/NGCCallAgent/NGCCallAgent/telemetryConstants"), r = e("jSkype/services/NGCCallAgent/NGCCallAgent/utils"), i = e("swx-utils-common").stopwatch, s = e("jSkype/services/NGCCallAgent/NGCCallAgent/ngcTelemetry"), o = function (e) {
      function E() {
        m[n.EXTENSIONS.CALL_START_TIME] = u, m[n.EXTENSIONS.CONVERSATION_SERVICE_URL] = e.signalingAgentConfig.conversationServiceUrl;
      }
      function S(e) {
        return e + ":" + (new Date().getTime() - u);
      }
      function x() {
        d && o.addVbssOperations(n.VBSS_OPERATION.CALL_END), m[n.EXTENSIONS.CALL_END_TIME] = new Date().getTime(), g && (m[n.EXTENSIONS.CONNECTED_DURATION_IN_MS] = g.duration()), a.length > 0 && (m[n.EXTENSIONS.NETWORK_REQUESTS_COMPLETED] = JSON.stringify(a)), l.length > 0 && (m[n.EXTENSIONS.LOCAL_OPERATIONS_PERFORMED] = JSON.stringify(l)), v.length > 0 && (m[n.EXTENSIONS.LOCAL_OFFER_ANSWER_TIME_IN_MS] = JSON.stringify(v)), h.length > 0 && (m[n.EXTENSIONS.INCOMING_MODALITIES] = JSON.stringify(h)), c.length > 0 && (m[n.EXTENSIONS.OUTGOING_MODALITIES] = JSON.stringify(c)), p.length > 0 && (m[n.EXTENSIONS.VBSS_OPERATIONS] = JSON.stringify(p));
        var e = [];
        for (var t in f)
          f.hasOwnProperty(t) && e.push(f[t]);
        e.length > 0 && (m[n.EXTENSIONS.NETWORK_REQUESTS_PENDING] = JSON.stringify(e)), w.log("sending telemetry data = " + r.getPrintableObject(m)), b.logConversationCallModalityEvent(m);
      }
      var o = this, u = new Date().getTime(), a = [], f = {}, l = [], c = [], h = [], p = [], d = !1, v = [], m = {}, g = null, y = null, b = s.getLogger(e), w = e.logger;
      E(), o.addLocalOperation = function (e) {
        l.push(S(e));
        ...
        a.push(S(e + ":" + s + ":" + i)), r.tryRemoveKeyFromHashTable(f, e);
        ...
        m[n.EXTENSIONS.CALL_TERMINATING_END] = e.terminatingEnd, m[n.EXTENSIONS.CALL_END_CODE] = e.endCode || t.CALL_END_CODE.SUCCESS, m[n.EXTENSIONS.CALL_END_SUB_CODE] = e.endSubCode || t.CALL_END_SUB_CODE.SUCCESS, m[n.EXTENSIONS.RESULT_VALUE] = e.resultValue || n.RESULT_VALUE.SUCCESS, m[n.EXTENSIONS.RESULT_DETAIL] = e.resultDetail || "Call gracefully hungup";
      }, o.startCallInitializationWatch = function (e) {
        y = i.build(), e && (y.msElapsed += e);
