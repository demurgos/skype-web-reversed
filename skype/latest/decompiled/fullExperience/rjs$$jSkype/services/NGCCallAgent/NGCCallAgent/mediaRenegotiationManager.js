define("jSkype/services/NGCCallAgent/NGCCallAgent/mediaRenegotiationManager", [
  ...
  var t = e("jSkype/services/NGCCallAgent/NGCCallAgent/constants"), n = e("jSkype/services/NGCCallAgent/NGCCallAgent/telemetryConstants"), r = e("jSkype/services/NGCCallAgent/NGCCallAgent/utils"), i = e("jSkype/services/NGCCallAgent/NGCCallAgent/mediaRenegotiationResponse"), s = e("jSkype/services/NGCCallAgent/NGCCallAgent/mediaRenegotiationRequest"), o = e("jSkype/services/NGCCallAgent/NGCCallAgent/mediaAcknowledgementRequest"), u = e("jSkype/services/NGCCallAgent/NGCCallAgent/mediaRenegotiationRejectionResponse"), a = e("jSkype/services/serviceAccessLayer/requestDispatcher"), f = e("jSkype/services/NGCCallAgent/NGCCallAgent/requestBuilder"), l = e("swx-utils-common").stopwatch, c = e("jcafe-property-model"), h = function (e, h) {
      function w(i) {
        b.log("raiseMediaRenegotiationOffer");
        y[t.LINKS.MEDIA_ANSWER] = i.mediaNegotiation.links.mediaAnswer;
        y[t.LINKS.MEDIA_REJECTION] = i.mediaNegotiation.links.rejection;
        var s = [];
        i.mediaNegotiation.callModalities && i.mediaNegotiation.callModalities.length > 0 && (s = r.getMediaTypes(i.mediaNegotiation.callModalities), e.telemetryHelper.addIncomingModalities(s), r.arrayContains(s, t.MEDIA_TYPES.SCREEN_SHARER) && e.telemetryHelper.addVbssOperations(n.VBSS_OPERATION.REMOTE_START));
        h.onOffer({
          mediaTypes: s,
      ...
      function E(t, i) {
        ...
        return f.get(e, n.NETWORK_REQUESTS.SEND_MEDIA_REJECTION, h).then(function (e) {
          ...
          v || e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.SEND_MEDIA_REJECTION, !0, o.duration());
          r.safelyResolvePromise(s, t.response);
        }).catch(function (t) {
          ...
          b.error("rejectMediaRenegotiation failed because : " + i);
          r.safelyRejectPromise(s, new Error("rejectMediaRenegotiation failed because : " + i));
        }), s.promise;
      }
      function S() {
        b.log("handleMediaAnswerTimeout");
        d && (d = !1, e.telemetryHelper.addVbssOperations(n.VBSS_OPERATION.TIMEOUT));
        e.telemetryHelper.addIncomingModalities("Timeout");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_ANSWER_TIMEOUT);
        e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER);
        p.handleMediaNegotiationFailure({
      ...
      function x() {
        b.log("handleMediaAnswerAcknowledgmentTimeout");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_ACKNOWLEDGEMENT_TIMEOUT);
        e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER_ACKNOWLEDGEMENT);
        h.onMediaAcknowledgementFailure(!0, new Error("timed out waiting for Media Answer Acknowledgement"));
      }
      ...
      p.acceptRenegotiationAsync = function (s, o, u) {
        b.log("acceptRenegotiationAsync called");
        o && b.log("acceptRenegotiationAsync called with mediaTypes : " + r.getPrintableObject(o));
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.ACCEPT_RENEGOTIATION);
        r.assertNotNullOrEmpty(y[t.LINKS.MEDIA_ANSWER], "MediaAnswer link not set");
        var h = c.task();
        switch (m) {
        ...
        e.telemetryHelper.setLocalOfferAnswerDuration(n.LOCAL_OFFER_ANSWER_TIMES.RENEGOTIATION_ANSWER_TIME + ":" + u);
        e.timeoutManager.startTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER_ACKNOWLEDGEMENT, x);
        ...
        return f.get(e, n.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, d).then(function (e) {
          ...
          v || e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, !0, p.duration());
          r.safelyResolvePromise(h, t.response);
        }).catch(function (i) {
          var s = r.getPrintableObject(i);
          b.error("acceptRenegotiationAsync failed because : " + s);
          v || (e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.SEND_MEDIA_ANSWER, !1, p.duration()), e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER_ACKNOWLEDGEMENT));
          r.safelyRejectPromise(h, new Error("acceptRenegotiationAsync failed because : " + s));
        }), h.promise;
      };
      p.startRenegotiationAsync = function (i, o, u, p) {
        b.log("startRenegotiationAsync called ");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.START_RENEGOTIATION);
        r.assertNotNullOrEmpty(o, "MediaRenegotiation link not set");
        var y = c.task();
        switch (m) {
        ...
        e.telemetryHelper.setLocalOfferAnswerDuration(n.LOCAL_OFFER_ANSWER_TIMES.RENEGOTIATION_OFFER_TIME + ":" + p);
        e.timeoutManager.startTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER, S);
        ...
        return x ? (d = !0, e.telemetryHelper.addVbssOperations(n.VBSS_OPERATION.START)) : !x && d && (d = !1, e.telemetryHelper.addVbssOperations(n.VBSS_OPERATION.STOP)), f.get(e, n.NETWORK_REQUESTS.START_RENEGOTIATION, E).then(function (e) {
          ...
          v || e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.START_RENEGOTIATION, !0, w.duration());
          r.safelyResolvePromise(y, t.response);
        }).catch(function (i) {
          var s = r.getPrintableObject(i);
          ...
          if (!v) {
            ...
            e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.START_RENEGOTIATION, !1, w.duration());
            e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER);
          }
      ...
      p.handleMediaAcknowledgment = function () {
        b.log("handleMediaAcknowledgment");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_ACKNOWLEDGEMENT);
        e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER_ACKNOWLEDGEMENT);
        h.onMediaAcknowledgementSuccess(!0);
      };
      p.onCallConnected = function () {
        b.log("onCallConnected");
        m = t.MEDIA_RENEGOTIATION_FSM_STATE.CALL_CONNECTED;
      };
      p.handleMediaNegotiationFailure = function (i) {
        b.log("handleMediaNegotiationFailure called . Details : " + r.getPrintableObject(i));
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_NEGOTIATION_FAILURE);
        e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER);
        switch (m) {
        case t.MEDIA_RENEGOTIATION_FSM_STATE.OUTGOING_RENEGOTIATION:
          m = t.MEDIA_RENEGOTIATION_FSM_STATE.CALL_CONNECTED;
        ...
        d && (d = !1, e.telemetryHelper.addVbssOperations(n.VBSS_OPERATION.REJECTED));
        e.telemetryHelper.addIncomingModalities("Rejected");
        h.onMediaRenegotiationRejection({
          code: i.code,
          subCode: i.subCode,
          phrase: i.phrase
        });
      ...
      p.handleMediaAnswer = function (i) {
        b.log("handleMediaAnswer called");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_ANSWER);
        switch (m) {
        case t.MEDIA_RENEGOTIATION_FSM_STATE.OUTGOING_RENEGOTIATION:
          m = t.MEDIA_RENEGOTIATION_FSM_STATE.CALL_CONNECTED;
          break;
        ...
        e.timeoutManager.stopTimer(t.TIMEOUT_OPERATIONS.MEDIA_ANSWER);
        var s = [];
        i.mediaAnswer.callModalities && i.mediaAnswer.callModalities.length > 0 && (s = r.getMediaTypes(i.mediaAnswer.callModalities), e.telemetryHelper.addIncomingModalities(s));
        h.onAnswer({
          provisional: !1,
          renegotiation: !0,
          mediaTypes: s,
        ...
        f.get(e, n.NETWORK_REQUESTS.SEND_MEDIA_ACKNOWLEDGEMENT, c).then(function (e) {
          ...
          var i = r.getPrintableObject(t);
          b.error("sending mediaAcknowledgement failed because : " + i);
          v || e.telemetryHelper.addNetworkOperationCompleted(n.NETWORK_REQUESTS.SEND_MEDIA_ACKNOWLEDGEMENT, !1, u.duration());
        });
      };
      p.handleMediaNegotiationOffer = function (r) {
        b.log("handleMediaNegotiationOffer called");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.HANDLE_MEDIA_OFFER);
        switch (m) {
        case t.MEDIA_RENEGOTIATION_FSM_STATE.OUTGOING_RENEGOTIATION:
      ...
      p.rejectRenegotiationAsync = function (i) {
        b.log("rejectRenegotiationAsync called");
        e.telemetryHelper.addLocalOperation(n.LOCAL_OPERATIONS.REJECT_RENEGOTIATION);
        r.assertNotNullOrEmpty(y[t.LINKS.MEDIA_REJECTION], "MediaRejection link not set");
        var s = i || {
      ...
      p.handleRetargetCompleted = function (t) {
        ...
        var i = r.getPrintableObject(t);
        b.log("handleRetargetCompleted called with : " + i);
        t.code === 0 ? h.onReTargetCompletedSuccess() : h.onReTargetCompletedFailure(i);
      };
      p.dispose = function () {
        b.log("mediaRenegotiationManager :: dispose");
        v = !0;
      };
    };
  return h;
