  ...
  return function (N, C, k) {
    ...
    function U(e) {
      function n(n) {
        ...
        s ? (r = r.replace(/\d+x>P$/, ""), I(r + (+s[1] + 1) + "x", !0)) : I("POK1x"), t.success(n);
      ...
      A.promise.then(function () {
        I("P"), H = new Date(), k.requestPolling(e).then(n, r);
      });
    }
    function z() {
    ...
    this._internal = {
      ...
      function a() {
        u++, u < L._internal.ANNOTATIONS_RETRY_COUNT && (t._actualId ? k.setMessageProperty(e, t._actualId, n, r).then(i, o) : setTimeout(a, L._internal.ANNOTATIONS_RETRY_TIMEOUT));
      }
      var u = 0;
      a();
      ...
      function a() {
        u++, u < L._internal.ANNOTATIONS_RETRY_COUNT && (t._actualId ? k.removeMessageProperty(e, t._actualId, n, r).then(i, o) : setTimeout(a, L._internal.ANNOTATIONS_RETRY_TIMEOUT));
      }
      var u = 0;
      a();
    }, this.removeAllMessages = function (e, t, n) {
      function s(e) {
        r.statusCode = e.response.status, t && t();
      }
      function o(i) {
        q(i, L.removeAllMessages.bind(L, e, t, n)) || n(i), r.statusCode = i.status;
      }
      ...
      function n(t) {
        e.error(t), q(t, L.pinUserToDogfoodCloud);
      }
      var e = N("pinToDogfood");
      k.pinToDogfood().then(t, n);
    }, this.ping = function () {
      var e = u.get();
      e.publish(y.ONLINE_STATE_CHANGED, b.OFFLINE), I("O");
      var t = N("ping");
      k.ping().then(function (r) {
        I("OOK"), e.publish(y.ONLINE_STATE_CHANGED, b.ONLINE), t.success(r), L.poll(), p.getInstance().reportSuccess("webapi-ping");
      }, function (n) {
        ...
        s ? (i = i.replace(/\d+x>O$/, ""), I(i + (+s[1] + 1) + "x", !0)) : I("OERR1x"), t.error(n), setTimeout(L.ping, o);
      });
    }, this.createConversation = function (e, t, r) {
      function s(e) {
        n.mark(w.NEW_CONVERSATION.CREATION_END_OK), i.success(e);
        var r = S(e.request, "location"), s = r.match(/threads\/(19:.*)$/)[1];
        t(s);
      }
      function o(s) {
        n.mark(w.NEW_CONVERSATION.CREATION_END_ERROR), i.error(s), q(s, L.createConversation.bind(L, e, t, r)), r(s);
      }
      ...
      function l(e) {
        I("SOK"), n.success(e), L.setEndpointPresence(), U(S(e.request, "location"));
      }
      function p(t) {
        e.error(t), v(t);
        if (R(t)) {
        ...
        if (t.status === g.forbidden) {
          f.clearRegistrationToken(), I("EERR403(" + t.getResponseHeader("contextId") + ";\"" + t.responseText + "\")" + !!d.get("registrationTokenRealTime")), L.poll();
          return;
        }
        I("EERR"), c.execute(L.poll);
      }
      function v(e) {
      ...
      function b(t) {
        ...
        v(f), I("EOK"), c.reset(), e.success(t), b = d.get(s.RESURECTION_KEY), b ? (d.remove(s.RESURECTION_KEY), m.timelineLoadOrigin = p.RESSURECT) : P() ? m.timelineLoadOrigin = p.RELOAD : m.timelineLoadOrigin = p.LOAD;
        ...
        if (n.subscriptions && n.subscriptions.length > 0) {
          ...
          O && g.publish(y.FORCE_RESYNC), w().finally(function () {
            I("S"), k.requestSubscriptionCreation(E).then(l, o);
          });
        O = !0;
      }
      function w() {
      ...
      I("E" + !!d.get(s.ENDPOINT_ID)), L._getEndpointId().then(function (e) {
      ...
      function a(e) {
        n.mark(w.IM_SEND.POST_END_OK + o), u.enqueueSentMessageInfo(t), r(e);
      }
      function f(i) {
        if (q(i, L.postMessage.bind(L, e, t, r, s)))
          return;
        n.mark(w.IM_SEND.POST_END_ERROR + o), u.enqueueSentMessageInfo(t), s(i);
      }
      var o = t.clientmessageid, u = i.get()._telemetry.messagesCollector;
      n.mark(w.IM_SEND.POST_START + o), k.postMessage(e, t).then(a, f);
      ...
      function s(n) {
        r.error(n), q(n, L.setConsumptionHorizon.bind(L, e, t));
      }
      ...
      return new Promise(function (e, t) {
        ...
        function i(e) {
          n.error(e), q(e, L.getFavorites.bind(L)) || t();
        }
      ...
      return new Promise(function (t, n) {
        ...
        function s(t) {
          r.error(t), q(t, L.setFavorites.bind(L, e)) || n();
        }
      ...
      function n(n) {
        t.error(n), q(n, L.setUserPresence.bind(L, e));
      }
      ...
      u.chatHistoryLoadResult[e] = g.OK, k.fetchMessages(e, t, n).then(a, f);
      ...
      function s(e) {
        n(e), h.isFeatureOn(r.featureFlags.DISABLE_POLLING_ON_KAHUNA) || F();
      }
      function o(r) {
