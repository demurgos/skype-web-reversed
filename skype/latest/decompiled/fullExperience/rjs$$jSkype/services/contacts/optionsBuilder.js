define("jSkype/services/contacts/optionsBuilder", [
  ...
  function s() {
    n.call(this), t.merge(this._defaultOptions.retry, r.getRetryPolicy()), t.merge(this._defaultOptions.headers, { "X-Skype-Caller": i.getBIAppName() }), this._defaultOptions.headers["X-Stratus-Caller"] = undefined;
  }
