define("jSkype/services/mediaAgent/webRtcSession", [
  ...
  var s = function (s, o) {
    function P(e) {
      f.error("Media error occurred", "type:", e.type, "detail:", e.detail);
      u.onSessionErrorOccurred && u.onSessionErrorOccurred(e);
    }
    function H(e) {
      d = e;
    ...
    function q(e) {
      x = e;
      M.setNegotiatedModalities(e);
    }
    function R() {
      f.log("reset candidate gathering");
      b.promise.then(function () {
      }, function () {
      });
      b.reject(new Error("reset candidate gathering"));
      b = t.defer();
    }
    function U() {
      b.resolve();
    ...
    function W() {
      O = setTimeout(function () {
        f.error("ice disconnected for ", A, "ms. Raise CONSTANTS.MEDIA_ERROR.iceConnectionError");
        P({
    ...
    function $() {
      return p || (p = s.maContext.getRelayManager().queryRelaysAsync("turn", s.config.isRemoteClientLync).then(function (t) {
        var n = {};
        f.log("create peer connection");
        a.sdes && S && !S.hasDtls() && (f.log("configuring peer connection to use SDES"), n.optional = [{ DtlsSrtpKeyAgreement: !1 }], M.setSdesSrtp(!0));
        h = new RTCPeerConnection({ iceServers: V(t) }, n);
        M.setPeerConnection(h);
        h.onnegotiationneeded = function (e) {
          var t = e.target;
        ...
        h.onaddstream = function (e) {
          f.log("onaddstream", "stream:", e.stream);
          e.stream.getAudioTracks().length > 0 && F(e.stream);
          e.stream.getVideoTracks().length > 0 && H(e.stream);
        };
        h.ontrack = function (e) {
          f.log("ontrack", "track:", e.track);
        };
        h.onremovestream = function (e) {
          f.log("onremovestream", "stream:", e.stream);
          B(e.stream);
          I(e.stream);
        };
        h.onicecandidate = function (e) {
          f.log("onicecandidate", "candidate:", e.candidate);
          e.candidate || U();
        };
        ...
        h.oniceconnectionstatechange = function (t) {
          var n = t.target;
          f.log("oniceconnectionstatechange", "iceConnectionState:", n.iceConnectionState, "pc.signalingState:", n.signalingState);
          n.iceConnectionState === "failed" && P({
            type: e.MEDIA_ERROR.iceConnectionError,
    ...
    function G(e) {
      return new Promise(function (n) {
        ...
        N = e;
        f.log("configure modalities", "audio:", e.audio, "video:", e.video, "peerconnection:", !!h, "pc.signalingState:", h ? h.signalingState : "-", "needNewRenegotiation:", r);
        r && Q();
        n();
      });
    }
          ...
          if (!h.addTrack) {
            var e = function () {
              if (g)
                try {
                  var e = g.getObject();
                  f.log("remove media stream", "audio tracks:", e.getAudioTracks(), "video tracks:", e.getVideoTracks());
                  h.removeStream(e);
                } finally {
                  g.dispose();
                  g = null;
            ...
            if (r && (u || a))
              return l.getMediaStreamRefAsync({
                ...
                try {
                  var n = t.getObject();
                  f.log("received media(stream api) tracks", "wantSendAudio:", u, "wantSendVideo:", a);
                  f.log("add media stream", "audio tracks:", n.getAudioTracks(), "video tracks:", n.getVideoTracks());
                  h.addStream(n);
                  g = t;
                } catch (r) {
                  try {
              ...
              if (g)
                try {
                  h.getSenders().forEach(function (e) {
                    f.log("remove sender", "track kind:", e.track.kind, "track id:", e.track.id);
                    h.removeTrack(e);
                  });
                } catch (e) {
            ...
            if (r && (u || a))
              return l.getMediaStreamRefAsync({
                ...
                try {
                  f.log("received media(track api) tracks", "wantSendAudio:", u, "wantSendVideo:", a);
                  e.getObject().getTracks().forEach(function (t) {
                    f.log("add stream", "track kind:", t.kind, "track id:", t.id);
                    h.addTrack(t, e.getObject());
                  });
                  g = e;
                } catch (n) {
                  try {
    ...
    function et() {
      return new Promise(function (e) {
        f.log("create [offer] configured:", N);
        J("no configured modalities to create offer for");
        w = !1;
        C = N;
        T = N;
        ...
        t.isOnHold(r) ? e(Y(T, !0, !0).then(function () {
          ...
          f.debug("create [offer] offer from peer connection", "sdp:", e.sdp);
          n = c.createLocalOffer(e.sdp);
          var t = n.toLocal(T);
    ...
    function tt(e) {
      return new Promise(function (n) {
        f.debug("process [offer]", "sdp:", e);
        S = c.createRemoteOffer(e);
        w = !1;
        T = t.invertModalities(S.getModalities());
        f.log("process [offer]", "offered:", T);
        Z();
        n(T);
      });
    }
    function nt(e) {
      return new Promise(function (n) {
        ...
        f.log("create [answer]", "offered:", T, "configured:", N);
        J("no configured modalities to create answer for");
        C = N;
        ...
        t.isOnHold(i) ? n(Y(i, !0, !0).then(function () {
          ...
          f.debug("create [answer] answer from peer connection", "sdp:", e.sdp);
          r = c.createLocalAnswer(e.sdp);
          var t = r.toLocal(x);
    ...
    function rt(e, n) {
      return new Promise(function (r) {
        ...
        if (!t.isOnHold(x)) {
          var o = i.toRemote(x);
          f.log("process [answer] set remote description", "negotiated:", x, "sdp:", o);
          r(h.setRemoteDescription(new RTCSessionDescription({
            sdp: o,
            type: "answer"
          })).then(function () {
            return x;
    ...
    function it() {
      return new Promise(function (e) {
        ...
        w = !0;
        f.log("negotiation completed", "isComplete:", r, "configured:", N, "negotiating:", C, "offered:", T, "negotiated:", x);
        n && Q();
        e({
          isComplete: r,
          activeModalities: x,
    ...
    function st(t, n) {
      return new Promise(function (r) {
        ...
        L = !1;
        f.warn("negotiation rejected", "isComplete:", i, "error:", t, "configured:", N, "negotiating:", C, "offered:", T, "negotiated:", x);
        z();
        t === e.RENEGOTIATION_ERROR.glare && (k = !0, w = !1);
        n && (f.log("retrying failed negotiation"), Q());
        r({
          isComplete: i,
          activeModalities: x,
          configuredModalities: N
      ...
      var r = function (e, n) {
        ...
        this.subscribeVideoAsync = function (e) {
          return f.info("subscribeVideoAsync", "msi:", e), new Promise(function (e) {
            ...
            var n = y.indexOf(r);
            n === -1 && y.push(r);
            d ? (r._attachMediaStream(d), e()) : (s = t.defer(), e(s.promise));
          });
        };
    ...
    function at() {
      ...
      ft().then(function () {
        ...
        z();
        X();
        u._onTerminated && u._onTerminated(u);
      });
    }
    function ft() {
    ...
    this.configureModalitiesAsync = G;
    this.createOfferAsync = et;
    this.processOfferAsync = tt;
    this.createAnswerAsync = nt;
    this.processAnswerAsync = rt;
    this.completeNegotiationAsync = it;
    this.rejectNegotiationAsync = st;
    this.createRemoteRenderer = ot;
    this.getStatsAsync = ft;
    this.terminate = at;
    this._deviceSelectionChanged = ut;
