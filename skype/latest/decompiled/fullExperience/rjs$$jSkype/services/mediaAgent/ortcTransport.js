define("jSkype/services/mediaAgent/ortcTransport", [
  ...
  function n(n, r, i, s, o, u, a) {
    ...
    this.start = function (e, t) {
      ...
      r.log("RTCIceTransport setRemoteCandidates", "candidates:", JSON.stringify(e));
      f.iceTransport.setRemoteCandidates(e);
      r.log("RTCIceTransport start", "remoteIceParams:", JSON.stringify(t), "role:", o.iceRole);
      f.iceTransport.start(f.iceGatherer, t, o.iceRole);
      r.log("RTCIceTransport start", "role:", f.iceTransport.role);
    };
    ...
    this.iceGatherer.onlocalcandidate = function (e) {
      r.log("RTCIceGatherer.onlocalcandidate", "candidate:", JSON.stringify(e.candidate));
      Object.keys(e.candidate).length === 0 && l.resolve();
    };
    this.iceGatherer.onerror = function (e) {
      r.error("RTCIceGatherer.onerror", "event:", e);
  ...
  function r(t, n, r) {
    var i = this, s = !1;
    this.dtlsTransport = new RTCDtlsTransport(n);
    ...
    this.dtlsTransport.onerror = function (n) {
      t.error("RTCDtlsTransport.onerror", "event:", n);
      r({
    ...
    this.dispose = function () {
      s && i.dtlsTransport.stop();
      i.dtlsTransport = null;
    };
  }
  function i(e, t, i, s, o, u) {
    ...
    var a, f, l, c = !1;
    a = new n(e, t.createChild("IceT"), i, s, o);
    l = new r(t.createChild("DtlsT"), a.iceTransport, s);
    u && (f = new n(e, t.createChild("RtcpIceT"), i, s, o, a.iceGatherer, a.iceTransport));
  ...
  function s(e, n) {
    function u(t) {
      ...
      this.iceCompleted = function () {
        this.gotCallback = !0;
        this.gotCallbackFromControlling = t === "controlling";
        var u = 0, a = 0;
        for (var f = 0; f < r.length; f++)
          r[f].gotCallback && u++, r[f].gotCallbackFromControlling && a++;
        a && a === o && !i && (e.log("IceCompletionMonitor REINVITE"), i = !0, n.triggerIceReinvite());
        u && u === r.length && (e.log("IceCompletionMonitor ALL COMPLETE"), s.resolve());
      };
    }
  ...
  function o(e, t, n, r, o, u) {
    ...
    this.assureInitAsync = function (r, s) {
      return new Promise(function (o) {
        ...
        var l = p().then(function (o) {
          ...
          !a && s[0] && (e.log("assureInitAsync AUDIO" + l.iceRole), a = new i("audio", e.createChild("AT"), c, n.raiseError, l, u));
          !f && s[1] && (e.log("assureInitAsync VIDEO" + l.iceRole), f = new i("video", e.createChild("VT"), c, n.raiseError, l, u));
        });
        o(l);
      });
    };
    this.getLocalParamsAsync = function () {
      return e.log("getLocalParamsAsync"), new Promise(function (e) {
        ...
        a && (t = a.getLocalParamsAsync());
        f && (n = f.getLocalParamsAsync());
        e(Promise.all([
          t,
          n
        ]));
    ...
    this.configureTransportAsync = function (e, t) {
      return new Promise(function (n) {
        ...
        t[0] && !l[0] ? r = a.startAsync(e[0]) : !t[0] && l[0] && (a.dispose(), a = null);
        t[1] && !l[1] ? i = f.startAsync(e[1]) : !t[1] && l[1] && (f.dispose(), f = null);
        l = t;
        n(Promise.all([
          r,
          i
