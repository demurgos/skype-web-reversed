define("jSkype/services/annotations/main", [
  ...
  function v() {
      ...
      t.forEach(e._supportedAnnotations, function (n) {
        ...
        t.forEach(s, function (e) {
          ...
          e.users.forEach(function (e) {
            var r = u.getId(e.mri);
            a.isMePerson(r) ? e.person = i : (e.person = a.getPersonById(r), e.person || (e.person = a.createDefaultPerson(r)));
            e.value && (e.value = o.getMessageSanitizedContent(o.unescapeHTML(e.value)));
    ...
    this.decorateEmotions = function (e, t) {
      if (e.emotions)
        return;
      e._supportedAnnotations.push(p.EMOTIONS);
      e._emotionsArray = f.collection();
    ...
    this.decorateTranslations = function (e, t) {
      ...
      if (e.translations)
        return;
      e._supportedAnnotations.push(p.TRANSLATIONS);
      e._translationsArray = f.collection();
    ...
    this.decoratePoll = function (e, t) {
      ...
      if (e.poll)
        return;
      e._supportedAnnotations.push(p.POLL);
      e._pollArray = f.collection();
