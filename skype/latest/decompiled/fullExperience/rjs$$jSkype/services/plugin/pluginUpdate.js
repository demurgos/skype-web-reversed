define("jSkype/services/plugin/pluginUpdate", [
  ...
  t.updateLatest = function (e, r) {
    ...
    function f() {
      e.onUpdateCheckComplete = l;
      e.onUpdateDownloadStarted = c;
      e.onUpdateDownloadComplete = h;
      e.onUpdateInstallStarted = p;
      e.onUpdateInstallComplete = d;
    }
    function l(e) {
      window.clearTimeout(i);
      e && !e.updateVersion ? u() : i = window.setTimeout(u, s.TIME_TO_START_DOWNLOAD);
    }
    function c() {
      window.clearTimeout(i);
      i = window.setTimeout(u, s.TIME_TO_FINISH_DOWNLOAD);
    }
    function h(e) {
      window.clearTimeout(i);
      e && !e.success ? u() : i = window.setTimeout(u, s.TIME_TO_START_INSTALL);
    }
    function p() {
      window.clearTimeout(i);
      window.setTimeout(u, s.TIME_TO_FINISH_INSTALL);
    }
    function d(e) {
      window.clearTimeout(i);
      u(e && e.success);
    ...
    f(e);
    a(e);
    i = window.setTimeout(u, s.TIME_TO_CHECK_FOR_UPDATE);
  };
});
