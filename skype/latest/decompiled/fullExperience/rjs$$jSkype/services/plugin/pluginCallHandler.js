define("jSkype/services/plugin/pluginCallHandler", [
  ...
  function h(e) {
    function m(t) {
      l.handleParticipantLeavingStateTransition(e.selfParticipant, t), l.handleRemoteParticipantsLeavingStateTransition(e.participants());
    }
    function g(e) {
      e && e.dispose();
    }
    function y(t) {
      u.log("[PluginCallHandler] handleConversationJoining", e.activeModalities.audio()), e.activeModalities.audio() ? t.skypeCore.joinCall(e.conversationId, T(), e._callHostId, e._callPayload.AccessToken) : (N(o.callConnectionState.Disconnecting, o.callDisconnectionReason.Terminated), N(o.callConnectionState.Disconnected, o.callDisconnectionReason.Terminated));
    }
    function b(t) {
      e.selfParticipant.video.channels.added.off(b), !t.isStarted() && t.isStarted.set.enabled() && t.isStarted.set(!0);
    }
    function w(n) {
      u.log("[PluginCallHandler] join conversation, pluginOthersAreLive:", e._callData.pluginOthersAreLive()), p = e._callData.pluginOthersAreLive.once(!0, y.bind(t, n));
    }
    function E(t) {
      u.log("[PluginCallHandler] handleAutoCall, mode", e._autoCallingService.autoCallingMode()), e._autoCallingService.autoCallingMode() === r.autoCallingMode.join && (u.log("[PluginCallHandler] handleAutoCall, audio state", e.activeModalities.audio()), h = e.activeModalities.audio.once(!0, function () {
        w(t);
      }), e.autoCall.once(!1, h.dispose)), (e._autoCallingService.autoCallingMode() === r.autoCallingMode.call || e._autoCallingService.autoCallingMode() === r.autoCallingMode.golive) && t.skypeCore.joinCall(e.conversationId, T());
    }
    function S() {
    ...
    function N(t, n) {
      e.selfParticipant.audio.state._set(t, n), e.selfParticipant.video.state._set(t, n);
    }
    function C(e) {
    ...
    function O(e) {
      return new Promise(function (t, n) {
        e === i.PLUGIN_MEDIA_TYPES.VIDEO && x(), f.createPlugin().then(function (n) {
    ...
    function M(e) {
      return new Promise(function (t, n) {
        function s() {
          A(o.mediaStreamState.Stopped), t(!0);
        }
        function u() {
          t(!0);
        }
        ...
        var r;
        e === i.PLUGIN_MEDIA_TYPES.SCREEN_SHARING ? r = u : (x(), r = s), f.createPlugin().then(function (t) {
    ...
    function H(e, t) {
      return new Promise(function (n, r) {
        f.createPlugin().then(function (r) {
          r.videoManager.hideParticipant(e, t, F()), n(!0);
        }, function (e) {
          I(e), r(e);
        });
      });
    ...
    t.canToggleMute = a.property({ value: e._callData.pluginRingingForMe() }), this.placeCall = function (t) {
      ...
      return f.createPlugin().then(function (t) {
        ...
        if (e.selfParticipant.audio.state() === o.callConnectionState.Notified)
          ...
          var n = B();
          u.log("[PluginCallHandler:acknowledge] processing incoming call"), e._callData.getUnprocessedIncomingCallPayloads().forEach(function (e) {
            u.log("[awaitCall] payload: ", e), t.skypeCore.awaitCall(e.evt, n, e.convoCallId, e.nsp, e.body.gp);
      ...
      var e = B();
      return f.createPlugin().then(function (t) {
        t.skypeCore.rejectCall(e), m(o.callDisconnectionReason.Busy);
      ...
      var t = a.task(), n = e._callData.oncePluginCallInfoReady(function () {
          c.clearTimeout(r), t.resolve(e._callData.pluginCallInfo());
      ...
      return f.createPlugin().then(function (e) {
        e.skypeCore.requestCallInfo(null, function () {
          n.dispose(), c.clearTimeout(r), t.reject("Failed to send command to plugin");
        });
      }), t.promise;
    }, this.dispose = function () {
      var n = F();
      t.canToggleMute(!1), t.toggleMuteTask = null, g(p), g(d), g(h), x(), n || f.dispose(!1), e.mediaConnectionType(o.mediaConnectionType.Unknown);
    };
  }
