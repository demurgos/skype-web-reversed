define("jSkype/services/plugin/electron/electronSkypeCore", [
  ...
  s.prototype = Object.create(n.prototype), s.prototype.constructor = s, s.prototype.load = function (e) {
    try {
      this._skypeModule.skypeCoreInit(e), this._skypeModule.skypeCoreSetEventHandler(n.prototype._raiseEvent.bind(this)), this._raiseLoadComplete(!0);
    } catch (t) {
    ...
    i.log(this.constructor.name + "::" + e + ", " + JSON.stringify(t)), n = n || s, r = r || s;
    try {
