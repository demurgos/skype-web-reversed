define("jSkype/services/plugin/pluginCore", [
  ...
  function v() {
    ...
    function P() {
      S && S.logPluginCrashed();
      T && T();
    }
    function H() {
      S && S.logPluginAlreadyRunning();
      T && T();
    }
    function B() {
    ...
    function U() {
      E.onCameraDeviceAdded = l.createOnDeviceAddedHandler(i.deviceType.Camera);
      E.onCameraDeviceRemoved = l.createOnDeviceRemovedHandler(i.deviceType.Camera);
      E.onCameraDeviceSelected = l.createOnDeviceSelectedHandler(i.deviceType.Camera);
      E.onMicrophoneDeviceAdded = l.createOnDeviceAddedHandler(i.deviceType.Microphone);
      E.onMicrophoneDeviceRemoved = l.createOnDeviceRemovedHandler(i.deviceType.Microphone);
      E.onMicrophoneDeviceSelected = l.createOnDeviceSelectedHandler(i.deviceType.Microphone);
      E.onSpeakerDeviceAdded = l.createOnDeviceAddedHandler(i.deviceType.Speaker);
      E.onSpeakerDeviceRemoved = l.createOnDeviceRemovedHandler(i.deviceType.Speaker);
      E.onSpeakerDeviceSelected = l.createOnDeviceSelectedHandler(i.deviceType.Speaker);
      p.get().devicesManager._initializedDevices = !0;
    }
    function z(e) {
    ...
    function X(e) {
      if (e.loginStatus === u.LOGIN_STATUS.LOGGED_IN) {
        N = 0;
        b.promise.state() === "pending" && b.resolve();
        return;
      }
    ...
    function $() {
      e.shouldReinitialize = !1;
      b.promise.state() === "pending" && b.reject();
      D();
    }
    function J() {
    ...
    function Q() {
      ...
      G(e.microphones);
      G(e.speakers);
      e.selectedCamera(undefined);
      e.selectedMicrophone(undefined);
      e.selectedSpeaker(undefined);
      delete p.get().devicesManager._initializedDevices;
    }
    function G(e) {
      var t, n;
