define("jSkype/modelHelpers/participantHelper", [
  ...
  t.updateParticipantAudioVideoState = function (e, t, n) {
    ...
    i.log("Updating participant", e.person.id(), " state to:", t, ", from:", e.audio.state(), "reason: ", n);
  ...
  t.handleParticipantRingingStateTransition = function (e, r) {
    e.audio.state() === n.callConnectionState.Disconnected && t.updateParticipantAudioVideoState(e, n.callConnectionState.Connecting);
    e.audio.state() === n.callConnectionState.Connecting && !r._callData.isCurrentCallIncoming() && t.updateParticipantAudioVideoState(e, n.callConnectionState.Ringing);
  };
  t.handleParticipantJoiningStateTransition = function (e, r) {
    t.handleParticipantRingingStateTransition(e, r);
    t.updateParticipantAudioVideoState(e, n.callConnectionState.Connected);
  };
  ...
  t.handleParticipantLeavingStateTransition = function (e, r) {
    r = r || n.callDisconnectionReason.Terminated;
    e.audio.state() === n.callConnectionState.Disconnected ? t.updateParticipantAudioVideoState(e, n.callConnectionState.Disconnected, r) : (e.audio.state() !== n.callConnectionState.Disconnecting && t.updateParticipantAudioVideoState(e, n.callConnectionState.Disconnecting, r), t.updateParticipantAudioVideoState(e, n.callConnectionState.Disconnected, r));
  };
  t.getOrCreateParticipantInConversation = function (e, n) {
    ...
    if (!i) {
      var s = r.getPerson(n);
      e._addParticipant(s);
      i = t.getParticipantFromConversation(e, n);
    }
    return i;
  };
