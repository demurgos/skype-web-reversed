  ...
  var i = function () {
    ...
    o.waitAny = function (e) {
      ...
      return t == 1 ? r = o.wait(e[0]) : t == 0 ? n.reject(Error()) : it(e, function (r) {
        r.then(function (e) {
          t--;
          n && (n.resolve(e), n = null, i(N("CompetingTaskResolved")));
        }, function (e) {
          t--;
          t || (n.reject(e), n = null);
        }, function () {
    ...
    o.waitAll = function (e) {
      ...
      return n.length = e.length, t == 0 ? r.resolve([]) : t == 1 ? i = o.wait(e[0]).then(function (e) {
        ...
        e.then(function (e) {
          ...
          a();
          t--;
          t || (r.resolve(n), r = null);
        }, function (e) {
          delete s[i];
          t--;
          r && (r.reject(e), r = null, u(e));
        }, a);
      })), i;
    };
    o.wait = function (e, t) {
    ...
    Y(p.prototype, {
      ...
      remove: function (e) {
        var t = this._, n, r, i;
        kt(e) ? (n = e, e = t.keys[n]) : n = t.idxs[e];
        r = t.vals[n];
    ...
    Tn.Query = function (e) {
      ...
      Et(e) ? it(e.split("&"), function (e) {
        var n, r, i = e.indexOf("=");
        i < 0 ? (n = e, r = "") : (n = e.slice(0, i), r = e.slice(i + 1));
