  ...
  function l() {
    ...
    y.init = function (n, r) {
      function w(n) {
        ...
        r ? (p("Getting key from KES"), s.decrypt(r).then(u, c)) : c();
      }
      ...
      s = new n();
      if (h !== v) {
        h ? (p("Version changed from " + h + " to " + v), O()) : (p("Version not found"), O(!0));
        i = !1;
        try {
    ...
    y.removeItem = function (e) {
      ...
      return new Promise(function (n) {
        c.then(function () {
          delete g[e];
          d || (T(m.getHashByKey(e)), m.removeKeyFromMap(e), typeof v[e] != "undefined" && (t("Item is removed prior encryption timeout finished. Cancelling encryption."), i.clearTimeout(v[e].timeout), v[e].rejectPromise(), delete v[e]));
          t("Removed");
          n();
        });
      });
