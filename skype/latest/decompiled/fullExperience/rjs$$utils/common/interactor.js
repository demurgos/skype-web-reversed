define("utils/common/interactor", [
  ...
  function l(e, t) {
    n.forEach(e.before, function (e) {
      Function.prototype.apply.call(e, t, [t.context].concat(t.arguments));
      f(t.context);
    });
  }
  function c(e, t) {
  ...
  function h(e, t) {
    (function n(r) {
      f(t.context);
      r < e.around.length ? Function.prototype.apply.call(e.around[r], t, [
        t.context,
        n.bind(null, r + 1)
      ].concat(t.arguments)) : Function.prototype.apply.call(e.run, t, [t.context].concat(t.arguments));
      f(t.context);
    }(0));
  }
  function p(e, t) {
    ...
    var t = n.map(e, u), r = {
        ...
        run: function () {
          ...
          try {
            ...
            i instanceof a || e.context.fail(i);
            n--;
            while (n >= 0)
  ...
  function m(e) {
    ...
    if (!e)
      return;
    e.run && this.run(e.run);
    e.before && (t = n.isArray(e.before) ? e.before : [e.before], n.forEach(t, function (e) {
      this.before(e);
    }, this));
    e.after && (t = n.isArray(e.after) ? e.after : [e.after], n.forEach(t, function (e) {
      this.after(e);
    }, this));
    e.onlyIf && (t = n.isArray(e.onlyIf) ? e.onlyIf : [e.onlyIf], n.forEach(t, function (e) {
      this.onlyIf(e);
    }, this));
    e.around && (t = n.isArray(e.around) ? e.around : [e.around], n.forEach(t, function (e) {
      this.around(e);
    }, this));
    e.rollback && this.rollback(e.rollback);
  }
