define("ui/viewModels/chat/conversation/callButtonViewModel", [
  ...
  var n = e("vendor/knockout"), r = e("swx-enums"), i = e("cafe/applicationInstance"), s = e("swx-i18n").localization, o = e("constants/common"), u = e("constants/calling"), a = e("ui/modelHelpers/personHelper"), f = e("services/serviceLocator"), l = e("utils/common/cafeObservable"), c = e("ui/modelHelpers/conversationHelper"), h = e("ui/viewModels/calling/helpers/callingFacade"), p = e("ui/controls/calling/sounds"), d = e("ui/telemetry/actions/actionNames"), v = e("ui/telemetry/chat/guestActionsInHeader"), m = e("ui/viewModels/chat/conversationActivity"), g = e("ui/modelObservers/agentAuthorizationObserver"), y = function (e) {
      function A(t) {
        O(), i.get().conversationsManager.conversations.add(e), h.placeCall(e, t, "startCallButton"), p.playOnce(p.KEYS.CALL_DIALING);
      }
      function O() {
      ...
      function j() {
        C && C.capabilities.audio.changed.off(_), k && k.capabilities.video.changed.off(D);
      }
      function F() {
      ...
      t.conversationModel = e, t.participants = l.newObservableCollection(e.participants), t.isOneToOneConversation = n.computed(function () {
      ...
      }), t.hasAudioCapability = n.observable(!0), t.hasVideoCapability = n.observable(!0), t.conversationModel.participants.changed(I), t.isAudioDisabled = n.computed(R), t.isVideoDisabled = n.computed(U), T = e.participants.observe(z), L = e.videoService.start.enabled.changed(function () {
