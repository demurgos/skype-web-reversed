  ...
  function y(e) {
    function O() {
      d.setupCQF().then(function (e) {
        t.callData = e, t.isCQFVisible(!0), t.isInCall(!1);
      }).catch(function () {
        t.isInCall(!1), _();
      });
    }
    ...
    function D(n) {
      t.isInCall() && s.refresh(), t.isConversationVisible(!0), t.isInCall(a.isCallingActive(e)), t.isFullyOverlayed(t.showStartConversationOverlay()), S = e.acknowledge.enabled.when(!0, e.acknowledge), T = t.isInCall.subscribe(function (e) {
    ...
    function P() {
      t.isConversationVisible(!1), t.conversationUpdateFlow.abandoned(), C && t.conversationModel.historyService._messagesWithUnseenHearts.size() > 0 && t.conversationModel.historyService._messagesWithUnseenHearts.empty();
    }
    function H(e) {
      e === c.chat.HEADER && L && t.dispatchEvent(l.events.conversation.OPEN_PROFILE, A, t.DIRECTION.CHILD);
    }
    function B() {
      t.forwardEvent(l.events.navigation.FRAGMENT_SHOW, t.DIRECTION.CHILD, D), t.forwardEvent(l.events.navigation.FRAGMENT_BEFORE_HIDE, t.DIRECTION.CHILD, P), t.forwardEvent(l.events.navigation.FRAGMENT_HIDE, t.DIRECTION.CHILD), t.forwardEvent(l.events.message.QUOTE, t.DIRECTION.CHILD), t.forwardEvent(l.events.message.EDIT, t.DIRECTION.CHILD), t.forwardEvent(i.EVENTS.CALL_SCREEN_CLOSE, t.DIRECTION.CHILD, O), t.forwardEvent(l.events.conversation.OPEN_PROFILE, t.DIRECTION.CHILD), t.forwardEvent(l.events.conversation.VIEWPORT_CHANGED, t.DIRECTION.CHILD), t.forwardEvent(l.events.conversation.MESSAGES_LOADED, t.DIRECTION.CHILD), t.registerEvent(l.events.roster.EDIT_ROSTER_MODE, I), t.registerEvent(l.events.conversation.OVERLAY_CLOSED, q), t.registerEvent(l.events.navigation.COMPONENT_RENDERED, H), t.registerEvent(i.EVENTS.CQF_SCREEN_CLOSE, M), r.subscribe(l.events.shareControl.SHARE_CONTROL_SHOW, R), r.subscribe(l.events.shareControl.SHARE_CONTROL_HIDE, U), f.get().conversationsManager.conversations.removed(j);
    }
    function j(t) {
      if (t === e) {
        var n = {
    ...
    function I(e) {
      t.isEditRosterMode(e.isActive), t.isEditing(e.isEditMode);
    }
    function q() {
      t.isFullyOverlayed(!1);
    }
    function R(e) {
      t.shareControlPayload(e), t.isSelectingContacts(!0);
    }
    function U() {
    ...
    t.init = function () {
      ...
      w = y.isFeatureOn(l.featureFlags.FILE_DRAG_DROP_ENABLED), C = y.isFeatureOn(l.featureFlags.HEARTS_ENABLED), t.hideConversationHeader = y.isFeatureOn(l.featureFlags.HIDE_CONVERSATION_HEADER), t.isSingleConversationMode = y.isFeatureOn(l.featureFlags.SINGLE_CONVERSATION_MODE), t.conversationModel = e, t.isEditRosterMode = o.observable(!1), t.isEditing = o.observable(!1), t.isFullyOverlayed = o.observable(!1), t.isSelectingContacts = o.observable(!1), t.showCover = o.pureComputed(function () {
        return !e.selfParticipant.isAnonymous() && t.isEditRosterMode() || t.isSelectingContacts();
      }), t.isInCall = o.observable(!1), t.isCQFVisible = o.observable(!1), t.isConversationVisible = o.observable(!0), t.conversationUpdateFlow = new u(), t.newConversationV2 = o.observable(y.isFeatureOn(l.featureFlags.NEW_CONVERSATION_V2)), t.shareControlPayload = o.observable({}), t.isPollsFeatureEnabled = o.observable(!1), b && !h.getBrowserInfo().isShellApp && (k = m.build(), N = v.build(k), N.subscribeToConversation(e)), t.onDragEnter = function (e, t) {
        var n = i(t);
        return n, s(t, n);
      ...
      })), F(), B(), g.get().onConversationJoined();
    }, t.dispose = function () {
      E.dispose(), S && S.dispose(), f.get().conversationsManager.conversations.removed.off(j), t.conversationUpdateFlow = null, x && x.dispose(), N && (N.dispose(), k.dispose()), T && T.dispose(), r.unsubscribe(l.events.shareControl.SHARE_CONTROL_SHOW, R), r.unsubscribe(l.events.shareControl.SHARE_CONTROL_HIDE, U);
