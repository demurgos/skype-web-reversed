define("ui/viewModels/chat/pes/expressionPicker", [
  ...
  function d(e, u, d) {
    function w() {
      i.execute(function () {
        v.isOpened(!1);
      }), c.body.removeEventListener("click", C, !0), v.dispatchEvent(o.expressionPicker.CLOSE_REQUEST, {}, v.DIRECTION.CHILD);
    }
    function E(e) {
      return {
        tabs: [],
    ...
    v.isDisabled = n.isObservable(e) ? e : n.observable(e), v.isOpened = n.observable(!1), v.isSelected = n.observable(!1), v.pagedTabs = n.observableArray(S(u)), v.selectedPageIndex = n.observable(0), v.selectedTab = n.observable(u[0]), v.tabsCss = n.computed(x), v.prevPageTitle = p.fetch({ key: "expressionPicker_prevPage" }), v.nextPageTitle = p.fetch({ key: "expressionPicker_nextPage" }), v.init = function () {
      O(), A();
    }, v.nextPage = function () {
      T(!1);
      ...
      if (n) {
        v.dispatchEvent(o.expressionPicker.ITEM_CANCEL_REQUEST, {}, v.DIRECTION.CHILD), L(n);
      ...
      l.unsubscribe(o.expressionPicker.MRUITEM_ADD_REQUEST, P), l.unsubscribe(o.expressionPicker.MRUITEM_ADD_EMOTICON_REQUEST, D), l.unsubscribe(o.personalExpression.CONFIG_PROCESSED, M);
    };
  }
