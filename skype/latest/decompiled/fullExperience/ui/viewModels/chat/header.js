define("ui/viewModels/chat/header", [
  ...
  function P(e, t) {
    ...
    function ot() {
      U(!1), H = null, it(), o.toggleEditMode(), d.publish(h.LEAVE_EDIT_MODE);
    }
    function ut(e) {
      var t = e().slice(0), r = U() ? !q() : q(), i;
      t.push(n.participants(0).person), i = p.createConversation(t, !0), i.isJoiningEnabled.set.enabled.once(!0, function () {
    ...
    function dt() {
      ...
      t.recordAction(D.conversation.addParticipantsButton), o.profileExpanded(!1), I = e.conversationUpdateFlow, I.start(n.participants().length, n.isGroupConversation());
    }
    function vt(e) {
      o.profileExpanded() || o.toggleProfile(undefined, e), e.editTopic && !o.topicEditorExpanded() && o.openTopicEditor();
    }
    function mt() {
    ...
    function Et(e) {
      var t = xt();
      t.parent = e.parent, E.get().onCopyLinkClicked(t);
    }
    function St(e) {
      var t = xt();
      t.parent = e.parent, E.get().onEmailLinkClicked(t);
    }
    function xt() {
      return {
    ...
    function Tt(e) {
      o.participantCount(e), R.isFeatureOn(c.featureFlags.INCLUDE_SELF_IN_PARTICIPANTS_COUNT) && o.participantCount(e + 1);
    }
    function Nt(e) {
    ...
    o._internal = { isModelTopicEditable: r.observable(!1) }, o.conversation = L.build(n, { contactOptions: { moodMessageFirst: !0 } }), o.callButtonViewModel = m.build(n), o.startCallButtonViewModel = g.build({
    ...
    }), o.editModeActive = r.observable(!1), o.canJoinCall = W.canJoinCall, o.initializeParticipants = r.observable(!1), o.hasNoSelectedParticipants = r.observable(!0), o.profileExpanded = r.observable(!1), o.isGroupConversation = v.newObservableProperty(n.isGroupConversation), o.canShowContactProfile = r.computed(yt), o.canExpandProfile = r.computed(bt), o.tabIndex = r.computed(wt), o.avatar = v.newObservableProperty(n.avatarUrl), o.topic = X.topic, o.canAddParticipants = r.observable(!1), o.contact = null, o.isAgent = o.conversation.isAgent, o.isPstn = o.conversation.isPstn, o.confirmButtonsVisible = r.computed(at), o.addParticipantsBtnClasses = r.computed(ft), o.addParticipantsBtnDisabled = r.computed(lt), o.isCallingDisabled = W.isCallingDisabled, o.spaceLink = r.observable(), o.isTooltipVisible = r.observable(!1), Z = n.participants.add.enabled.changed(function (e) {
      o.canAddParticipants(e);
    }), Y = n.topic.set.enabled.changed(Nt), o.spaceTopicEditorEnabled = R.isFeatureOn(c.featureFlags.SPACE_TOPIC_EDITOR), o.isServiceEnabled = v.newObservableProperty(o.conversationModel.chatService.sendMessage.enabled), o.topicEditable = r.computed(function () {
    ...
    }), o.editTopicTitle = a.fetch({ key: "spaces_welcomeRenameBtnTitle" }), o.editTopicConfirmAria = a.fetch({ key: "action_button_confirm" }), o.editTopicCancelAria = a.fetch({ key: "action_button_cancel" }), o.editTopic = r.observable(""), o.topicEditorExpanded = r.observable(!1), o.topicHasFocus = r.observable(!1), o.participantCount = r.observable(n.participantsCount()), n.participantsCount.changed(Tt), o.isIntegratedProperty = r.observable(M.get().isIntegratedProperty()), o.showMoreActions = function () {
      return R.isFeatureOn(c.featureFlags.SCHEDULE_CALL_FROM_CONVERSATION) && !J && !K;
    }, o.closeTopicEditor = function () {
      o.topicEditorExpanded(!1), o.editTopic("");
    }, o.openTopicEditor = function () {
      o.editTopic(x.getSanitizedTopic(n.topic())), o.topicEditorExpanded(!0), o.topicHasFocus(!1), P.onTopicEdit();
    ...
    }), B = o.editModeActive.subscribe(st), j = o.profileExpanded.subscribe(st), o.focusRestrict = function () {
      o.profileExpanded() && t.restrict();
    }, o.init = function (e) {
      P = e, P.init({
        toggleProfile: o.toggleProfile,
        abandonEditMode: pt
      }), F = o.addParticipantsBtnDisabled.subscribe(ht), n.isGroupConversation() && (o.spaceLink = v.newObservableProperty(n.uri)), o.forwardEvent(y.roster.ROSTER_QUERY_CHANGED), o.forwardEvent(y.roster.ROSTER_QUERY_EXECUTED), o.forwardEvent(y.roster.ROSTER_SELECTION_REMOVED), o.forwardEvent(y.roster.PICKER_CONTACT_SELECTED), o.forwardEvent(y.roster.PICKER_CONTACT_DESELECTED), o.registerEvent(y.conversation.JOINING_ENABLED, ct), o.registerEvent(y.conversation.OPEN_PROFILE, vt), o.registerEvent(y.conversation.CLOSE_PROFILE, mt), o.registerEvent(y.conversation.COPY_LINK, Et), o.registerEvent(y.conversation.EMAIL_LINK, St), o.registerEvent(y.conversation.MESSAGES_LOADED, o.focusRestrict), d.subscribe(c.events.shareControl.SHARE_CONTROL_SHOW, _t), d.subscribe(c.events.shareControl.SHARE_CONTROL_HIDE, Dt), Pt(), Ht();
    }, o.dispose = function () {
      B.dispose(), j.dispose(), F.dispose(), o.selectedContactsSubscription && o.selectedContactsSubscription.dispose(), o.confirmButtonsVisible.dispose(), o.addParticipantsBtnDisabled.dispose(), o.addParticipantsBtnClasses.dispose(), o.topicEditable.dispose(), o.canEditTopic.dispose(), o.isAdmin.dispose(), o.canShowContactProfile.dispose(), o.canExpandProfile.dispose(), o.tabIndex.dispose(), P && P.dispose(), P = null, o.conversation.dispose(), W.dispose(), X.dispose(), o.callButtonViewModel.dispose(), o.startCallButtonViewModel.dispose(), Y && Y.dispose(), Z && Z.dispose(), o.translatorServiceStateObservable && o.translatorServiceStateObservable.dispose(), n.participantsCount.changed.off(Tt), Ot(), Mt(), o.conversationModel.participants.changed.off(At), d.unsubscribe(c.events.shareControl.SHARE_CONTROL_SHOW, _t), d.unsubscribe(c.events.shareControl.SHARE_CONTROL_HIDE, Dt), u.remove("conversationHeader");
      ...
      o.profileExpanded(!i), o.profileExpanded() ? (u.add("conversationHeader", o.toggleProfile), t.restrict()) : (u.remove("conversationHeader"), t.restore());
      if (n.isGroupConversation()) {
        var s = xt();
        s.telemetryItem = e, s.profileExpanded = i, E.get().onProfileToggled(s), o.initializeParticipants(!0), o.profileExpanded() && o.editModeActive() && ot(), o.profileExpanded() || o.closeTopicEditor(), P.onEditModeToggled(o.profileExpanded());
      } else if (o.profileExpanded()) {
        var a = r && r.source ? r.source : w.conversation.header.button;
        _.profileOpened(a);
      }
    }, o.setParticipantProvider = function (e) {
      o.selectedContactsSubscription && o.selectedContactsSubscription.dispose(), H = e, o.selectedContactsSubscription = H.selectedContacts.subscribe(it), it();
    }, o.toggleEditMode = function () {
      var e = !o.editModeActive();
      o.editModeActive(e), e && dt(), P.onEditModeToggled(e);
    }, o.showTooltip = function () {
      z && window.clearTimeout(z), o.isTooltipVisible(!0);
    }, o.hideTooltip = function () {
      z = window.setTimeout(function () {
        o.isTooltipVisible(!1);
      }, 500);
    }, o.undoSelectedParticipants = function () {
      ot(), I.cancelled(), I = null;
    }, o.submitSelectedParticipants = function () {
      var e = H.selectedContacts, t = e().length;
      I.completed(t), n.isGroupConversation() ? (U() && n.isJoiningEnabled.set(!q()), p.addPersonsToConversation(e(), n).then(rt)) : ut(e), ot();
  ...
  n.assign(P.prototype, o), t.build = function (e, t) {
    return new P(e, t);
  };
})
