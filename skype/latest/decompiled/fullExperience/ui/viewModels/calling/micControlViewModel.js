define("ui/viewModels/calling/micControlViewModel", [
  ...
  function l(e, l) {
    ...
    t.call(c, e, d), c.isMicrophoneAvailable = n.computed(function () {
      return h() !== null;
      ...
      c.isMicrophoneButtonEnabled() && (e.selfParticipant.audio.isMuted(c.isMicrophoneOn()), v()), o.swallow(n);
    }, c.dispose = function () {
      h.dispose(), c.microphoneStateText.dispose(), p.dispose();
    };
  }
