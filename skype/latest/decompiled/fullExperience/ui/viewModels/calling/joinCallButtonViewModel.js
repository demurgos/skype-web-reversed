define("ui/viewModels/calling/joinCallButtonViewModel", [
  ...
  function c(e) {
    function h() {
      var e = !1;
      i.get().conversationsManager.conversations.add(n), o.placeCall(n, e, "startCallButton"), u.playOnce(u.KEYS.CALL_DIALING);
    }
    var t = this, n = e.conversationModel, c;
    c = a.build(n), t.icon = e.showIcon === !0 ? "callStart" : "", t.cssClass = e.cssClass, t.tabIndex = e.tabIndex, t.isOnCall = c.isOnCall, t.isJoinCallDisabled = c.isJoinCallDisabled, t.joinCallTitle = r.fetch({ key: "button_text_joinCall" }), t.joinCall = function () {
      var e = l.resolve(f.serviceLocator.ACTION_TELEMETRY);
      e.recordAction(s.audioVideo.joinCall), h();
    }, t.dispose = function () {
      c.dispose();
    };
  }
