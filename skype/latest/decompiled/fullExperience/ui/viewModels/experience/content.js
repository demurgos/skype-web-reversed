define("ui/viewModels/experience/content", [
  ...
  function a() {
    ...
    e.showOverlay = t.observable(!1), e.init = function () {
      a.subscribe(o.narrowMode.SIDEBAR_STATE_CHANGED, e.showOverlay), s.mark(u.EXPERIENCE.CONTENT_INIT);
    }, e.dispose = function () {
      a.unsubscribe(o.narrowMode.SIDEBAR_STATE_CHANGED, e.showOverlay);
    }, e.hideOverlay = function () {
      var t = { source: i.search.reset.content };
      e.showOverlay(!1), a.publish(o.search.RESET, t);
    };
  }
