define("ui/appOverlay/appOverlay", [
  ...
  function f() {
    if (!o) {
      ...
      t.registeredElements.length ? e = n.querySelector(t.registeredElements[0].element) : e = n.querySelector("body"), o = e.parentNode;
    }
    u = r.createElement("div"), u.id = a, o.appendChild(u);
  }
  function l() {
    o.removeChild(n.querySelector("#" + a)), u = null, o = undefined;
  }
