define("ui/components/chat/suggestions/simpleWordSuggestion", [
  ...
  return n.prototype.applySuggestion = function (n) {
    ...
    o === "" && (s += "\xA0"), r = r.slice(0, i.start) + s + o, this.textarea.viewModel.messageBody(r), this.textarea.view.setCursorAt(i.start + s.length), n.data.criteriaLength = i.end - i.start, n.data.suggestionType = this.suggestionType;
  }, n;
})
