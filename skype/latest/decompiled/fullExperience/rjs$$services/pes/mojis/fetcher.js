define("services/pes/mojis/fetcher", [
  ...
  function a() {
    function a(e, r) {
      ...
      f.isFeatureOn(o.featureFlags.PES_CDN_AUTH_ENABLED) && (a = i.rewriteUrls(a, u.pesCDNAuthentication.rewriteRules)), e.thumbnailUrl = a + n.profiles.moji.thumbnail, e.contentUrl = a + n.profiles.moji.content, r._requiresCDNUrlAuthentication && (e.thumbnailUrl = e.thumbnailUrl + "?" + r._cdnToken, e.contentUrl = e.contentUrl + "?" + r._cdnToken), e.text = "/moji " + e.id, e.thumbnailClass = "id_" + e.id + " thumbnail", e.keyframeClass = "id_" + e.id + " keyframe", e.isPlaying = t.observable(!1), e.isPlayed = t.observable(!1), e.isLocked = t.observable(!1), e.onPlayed = function () {
      }, e.visible = !0;
    }
    var e = this;
