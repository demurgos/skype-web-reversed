define("services/pes/tabs/fetcher", [
  ...
  function i() {
    function i(e, t) {
      ...
      e.index = t, e.ariaLabel = e.title, e.active = r.observable(!1), e.hover = r.observable(!1), e.htmlClass = r.observable(i), e.showHiddenItems = e.id === n.mru.TAB_ID, e.onMouseOver = function () {
        e.hover(!0);
