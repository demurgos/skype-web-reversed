define("services/pes.v2/interactors/mru", [
  "require",
  "exports",
  "module",
  "lodash-compat",
  ...
  var n = e("lodash-compat"), r = e("constants/common"), i = e("swx-i18n").localization, s = e("utils/common/interactor"), o = e("services/pes/constants"), u = e("services/serviceLocator"), a = e("experience/settings");
  t.createMRUTab = s.defineInteractor(function (e) {
    ...
    e(function (e) {
      var i = u.resolve(r.serviceLocator.PES_2_MRU_SERVICE), o = i.getMRUItems(), a = t(), f = l();
