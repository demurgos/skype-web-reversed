define("services/pes.v2/interactors/store", [
  ...
  t.setStoreTabProperties = r.defineSimpleInteractor(function (e) {
    ...
    i = e.purchasedTabs = e.purchasedTabs || [], u = e.purchasedTabIds = e.purchasedTabIds || {}, n.downloadPurchasedTabsFromEntitlement().then(function (n) {
      n.forEach(function (s) {
        s.pesConfig.then(function (o) {
          i[s.id] = o.tabs[0], e._configuredItems = e._configuredItems.concat(o.items), r++, r === n.length && typeof t == "function" && t();
        }), u.push(s.id);
      });
    });
    ...
    t.forEach(function (t) {
      n.remove(e.tabs, { id: t }), e.tabs.splice(4, 0, r[t]);
    });
  }), t.putNewPurchasedTab = r.defineSimpleInteractor(function (e, t, n) {
    var r = e.purchasedTabIds, i = e.purchasedTabs;
    r.push(t), i[t] = n.tabs[0], e._configuredItems = e._configuredItems.concat(n.items), e.tabs.splice(4, 0, i[t]);
  });
})
