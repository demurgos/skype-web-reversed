function (e) {
  ...
  function l() {
    ...
    n.addClass(e, "overlaySlide"), n.addClass(t, "table"), n.addClass(r, "tableCell"), n.addClass(s, "overlaySlideContent"), n.addClass(s, "themeWhite"), s.tabIndex = -1, s.setAttribute("role", "dialog"), s.setAttribute("aria-label", ""), r.appendChild(s), t.appendChild(r), e.appendChild(t), i = e;
  }
  function c() {
    var e = document.createElement("div");
    n.addClass(e, "overlayContainer"), r = e;
  }
  function h(e) {
    var t = {};
  ...
  function p(e) {
    ...
    }), n.addClass(t, e.inactiveTransitionClass)), n.bind(t, n.cssTransitionEndEventName, f), n.addClass(t, e.inactiveClass);
  }
  function d(e) {
    if (n.cssTransitionsSupported === !1 || e === null) {
    ...
    }), n.addClass(o.slide, e.activeTransitionClass)), n.addClass(o.slide, e.activeClass), window.setTimeout(function () {
      n.removeClass(o.slide, e.activeClass);
    }, 10), r.appendChild(o.slide);
  }
  function v(e) {
    var t;
    if (s === !1)
      return;
    t = e.target, r.contains(t) === !1 && o.contentContainer.focus();
  }
  function m(e) {
    e.keyCode === 27 && t.hide();
  }
